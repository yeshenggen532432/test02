 ...
 * @description:
 */
public class TokenObjectMapper extends ObjectMapper {
    private static final long serialVersionUID = 1L;
    private static Logger logger = LoggerFactory.getLogger(TokenObjectMapper.class);
    private static TokenObjectMapper mapper;

    public TokenObjectMapper() {
        this(JsonInclude.Include.ALWAYS);
    }

    public TokenObjectMapper(JsonInclude.Include include) {
        if (include != null) {
    ...
    public static TokenObjectMapper getInstance() {
        if (mapper == null) {
            mapper = (new TokenObjectMapper()).enableSimple();
        }

        return mapper;
    }

    public static TokenObjectMapper nonDefaultMapper() {
        if (mapper == null) {
            mapper = new TokenObjectMapper(JsonInclude.Include.NON_DEFAULT);
        }
    ...
    public TokenObjectMapper enableEnumUseToString() {
        this.enable(SerializationFeature.WRITE_ENUMS_USING_TO_STRING);
        this.enable(DeserializationFeature.READ_ENUMS_USING_TO_STRING);
        return this;
    }

    public TokenObjectMapper enableJaxbAnnotation() {
        JaxbAnnotationModule module = new JaxbAnnotationModule();
        this.registerModule(module);
        return this;
    }

    public TokenObjectMapper enableSimple() {
