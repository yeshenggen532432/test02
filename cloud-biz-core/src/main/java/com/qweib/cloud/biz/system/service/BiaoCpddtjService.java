...
import com.qweib.cloud.repository.BiaoCpddtjDao;
...
@Service
public class BiaoCpddtjService {
	@Resource
	private BiaoCpddtjDao cpddtjDao;
	@Resource
	 ...
	 */
	public Page queryBiaoCpddtj(BiaoCpddtj Cpddtj,SysLoginInfo info, String dataTp,Integer page,Integer limit){
		try {
			...
			return this.cpddtjDao.queryBiaoCpddtj(Cpddtj, datasource, mId, allDepts, invisibleDepts, page, limit);
		} catch (Exception e) {
	 ...
	 */
	public Page queryBiaoCpddtjWeb(BiaoCpddtj Cpddtj,OnlineUser user, String dataTp,Integer page,Integer limit,String mids,Integer jepx){
		try {
			...
			return this.cpddtjDao.queryBiaoCpddtjWeb(Cpddtj, datasource, map, page, limit,mids,jepx);
		} catch (Exception e) {
			throw new ServiceException(e);
		}
	}
