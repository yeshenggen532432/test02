...
public class CurrencyUtils {
    ...
    public static String formatAndConvert(Double num) {
        num = num == null ? 0d : num;
        String amount = StrUtil.formatMny2(num);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(convert(StrUtil.formatMny("7054")));
        System.out.println(convert(StrUtil.formatMny("7054.23")));
        System.out.println(convert(StrUtil.formatMny("13017054")));

        System.out.println(formatAndConvert(0d));
        System.out.println(formatAndConvert(null));
        System.out.println(formatAndConvert(7054d));
        System.out.println(formatAndConvert(7054.233));
        System.out.println(formatAndConvert(13017054d));
        System.out.println(formatAndConvert(7054.11d));
    }
