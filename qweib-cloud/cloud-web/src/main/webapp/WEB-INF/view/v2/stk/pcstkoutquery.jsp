...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div id="tb" style="padding:5px;height:auto">
		     销售单号: <input name="orderNo" id="orderNo" style="width:120px;height: 20px;" onkeydown="toQuery(event);"/>
			...
			下单日期: <input name="sdate" id="sdate"  onClick="WdatePicker();" style="width: 100px;" value="${sdate}" readonly="readonly"/>
	         ...
	         单据状态: <select name="orderZt" id="billStatus">
	                    <option value="未发货">未发货</option>	                   
	                    <option value="已发货">已发货</option>
	                    <option value="作废">作废</option>
	                    <option value="终止未发完">终止未发完</option>
	                </select>	
	          单据类型: <select name="outType" id="outType">
	                    <option value=""></option>	                   
		...
		<script type="text/javascript">
			...
			function queryorder(){
				...
				$("#datagrid").datagrid('load',{
					url:"manager/stkOutPage?database="+database,
					jz:"1",
					isPay:isPay,
					billNo:$("#orderNo").val(),
					khNm:$("#khNm").val(),
