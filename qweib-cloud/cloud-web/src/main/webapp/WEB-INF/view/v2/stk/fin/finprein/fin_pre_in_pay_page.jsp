        ...
        <div class="layui-card-body full">
            <div id="grid" uglcw-role="grid"
                 uglcw-options="{
                    ...
                    url:'manager/queryFinPreInPayPage?sourceBillId=${billId}',
                    criteria: '.form-horizontal',
                      dataBound: function(){
                ...
                <div data-field="sourceBillNo" uglcw-options="width:170">预收单号</div>
                ...
                <div data-field="sumAmt" uglcw-options="width:120">付款/核销金额</div>
...
<script type="text/x-kendo-template" id="formatterSt3">
    ...
    <button class="k-button k-error" onclick="cancelBill(#= data.id#, 1,#=data.billType#)"><i class="k-icon"></i>作废</button>
    # } #
</script>
...
<script>
    ...
    function cancelBill(id,status,billType) {
        if(billType==2){
            uglcw.ui.warning("抵扣款不允许作废");
            return;
        }
        uglcw.ui.confirm('您确认要作废吗？', function () {
            $.ajax({
                url: "manager/cancelInBack",
                type: "post",
                data: "recId=" + id,
