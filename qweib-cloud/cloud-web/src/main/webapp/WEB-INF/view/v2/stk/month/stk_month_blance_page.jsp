        ...
        <div class="uglcw-layout-content">
                ...
                <div class="layui-card-body">
                    <ul class="uglcw-query form-horizontal">
                        <li>
                            ...
                            <input type="hidden" uglcw-model="mastId" id="mastId" value="${mastId}" uglcw-role="textbox">
                            <input type="hidden" uglcw-model="waretype" value="0" id="wareType" uglcw-role="textbox">
                            <input uglcw-role="textbox" uglcw-model="yymm" readonly placeholder="年月" value="${yymm}">
                        </li>
                        <li>
            ...
            <div class="layui-card">
                <div class="layui-card-body full">
                    ...
                    url: '${base}manager/stkMonthBlance/pages',
