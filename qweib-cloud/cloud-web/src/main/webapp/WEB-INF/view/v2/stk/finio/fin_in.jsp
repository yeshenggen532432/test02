                ...
                <div class="layui-card-body">
                    <form class="form-horizontal" uglcw-role="validator">
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label col-xs-3">借入时间</label>
                            <div class="col-xs-4">
                        ...
                        <div class="form-group" style="margin-bottom: 0px;">
                            ...
                            <div class="col-xs-4">
                                <select uglcw-role="combobox" uglcw-validate="required" uglcw-model="accId" uglcw-validate="required"
                ...
                <div class="layui-col-md5">
                    <div class="layui-row layui-col-space5">
                        <div class="layui-col-md4">
							...
							url:'${base}manager/queryIoTypeList?typeName=其它应付款',
...
<script>
    ...
    function add() {
        uglcw.ui.openTab('往来借入开单', '${base}manager/toFinInEdit?r=' + new Date().getTime());
    }
    ...
    function audit() {
        ...
        uglcw.ui.confirm('是否确定审核？', function () {
            uglcw.ui.loading();
            $.ajax({
                url: '${base}manager/updateFinInAudit',
                type: 'post',
        ...
        $.ajax({
            ...
            success: function (json) {
                if(json.state){
                    ...
                    {
                        if(json.rows[i].itemName=='其它应付借入款项'){
                            uglcw.ui.get('#grid').addRow({
