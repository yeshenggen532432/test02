				...
				<div class="layui-card-body full">
					<div id="grid" uglcw-role="grid"
                      ...
                      if(amtType !=''){
                        ...
                        q.amtType = amtType;
                         uglcw.ui.openTab('往来预付款统计', '${base}manager/toFinPreOutUnitStat?'+ $.map(q, function(v, k){
                    ...
                    criteria: '.form-horizontal',
						...
						<div data-field="amt1"
							 uglcw-options="width:200,format: '{0:n2}',
							 template: uglcw.util.template($('#colour').html())">
						</div>
