            ...
            <div id="grid" uglcw-role="grid"
                 uglcw-options="{
                    ...
                    dblclick: function(row){
                        uglcw.ui.openTab('盘点成本'+row.id,'${base}manager/cost/stkCostCheck/show?billId='+row.fdId);
                    },
                    url: '${base}manager/cost/stkCostCheck/pages',
                    criteria: '.form-horizontal',
                     dataBound: function(){
                ...
                <div data-field="billType" uglcw-options="width:160,tooltip: true">盘点类型</div>
                ...
                <div data-field="outAmt" uglcw-options="width:100">盘点金额</div>
...
<script>
    ...
    function showSourceBillNo(id) {
        uglcw.ui.openTab('盘点信息' + id, "${base}manager/showStkcheck?dataTp=1&billId=" + id)
    }
