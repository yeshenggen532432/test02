            ...
            <div id="grid" uglcw-role="grid"
                 uglcw-options="{
                    ...
                    dblclick: function(row){
                        uglcw.ui.openTab('组装拆卸成本'+row.id,'${base}manager/cost/stkCostZzcx/show?billId='+row.fdId);
                    },
                    url: '${base}manager/cost/stkCostZzcx/pages',
                    criteria: '.form-horizontal',
                     dataBound: function(){
                ...
                <div data-field="billType" uglcw-options="width:160,tooltip: true">单据类型</div>
...
<script>
    ...
    function showSourceBillNo(id) {
        uglcw.ui.openTab('组装拆卸信息' + id, "${base}manager/stkZzcx/show?dataTp=1&billId=" + id)
    }
