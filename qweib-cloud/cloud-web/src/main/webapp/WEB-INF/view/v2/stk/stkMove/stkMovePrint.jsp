...
<div style=" text-align: center; margin:10px auto;width:794px;height:550px;border:1px solid #000000;" id="printcontent">  
    <table style="border-color: #000000;width:794px;">  
	    <tr>
		<td colspan = "6" style="font-size:18px;color:#000000;font-weight:bold;">移库单</td>
		</tr>
       <tr>
	...
	<thead>
		...
		<td style="font-weight:bold;border:1px solid #000000;display:none">移库金额</td>
		</tr>
	</thead>
    <tbody id="chooselist">
	</tbody>
	...
	<c:forEach items="${stkMove.list}" var="item" >
      <tr>  
		  ...
		  <td style="border:1px solid #999999;">
			...
			<td style="border:1px solid #999999;"><fmt:formatNumber value="${item.qty}" pattern="#0.00" /></td>
         ...
         <tr>
      		...
      		<td style="border:1px solid #999999;"></td>
      		<td style="border:1px solid #999999;">
      		<fmt:formatNumber value="${item.sumQty}" pattern="#0.00" /> 
      		</td>
