                ...
                <div>
                    ...
                    <div id="grid0" uglcw-role="grid"
                         uglcw-options="
							...
							id:'id',
							pageable: true,
                    		url: '${base}manager/queryMyAuditPage?isOver=1',
                    		criteria: '.query0',
                ...
                <div>
                    ...
                    <div id="grid1" uglcw-role="grid"
                         uglcw-options="
							...
							autoBind:false,
							pageable: true,
                    		url: '${base}manager/queryMyAuditPage?isOver=3',
                    		criteria: '.query1',
                    		dblclick:function(row){
                    		    toTab(row)
                    		}
                        ...
                        <div data-field="auditNo" uglcw-options="width:160,tooltip:true">审批编号</div>
                        <div data-field="title" uglcw-options="width:160,tooltip:true">标题</div>
                        <div data-field="checkTime" uglcw-options="width:160,tooltip:true">审批时间</div>
                        <div data-field="checkNm" uglcw-options="width:160,tooltip:true">等待审批人</div>
                    </div>
                </div>
                <div>
                    <ul class="uglcw-query query2">
                        <li class="level">
                            <input uglcw-model="search" uglcw-role="textbox" placeholder="标题;详情;">
                        </li>
                        <li class="level">
                        ...
                        <li>
                            <button id="search2" uglcw-role="button" class="k-button k-info">搜索</button>
                            <button id="reset2" class="k-button" uglcw-role="button">重置</button>
                        </li>
                    </ul>
                    <div id="grid2" uglcw-role="grid"
                         uglcw-options="
							...
							autoBind:false,
							pageable: true,
                    		url: '${base}manager/queryMyAuditPage?isOver=4',
                    		criteria: '.query1',
                    		dblclick:function(row){
                    		    toTab(row)
                    		}
...
<script>
    $(function () {
        ...
        $('#reset2').on('click', function () {
            uglcw.ui.clear('.query2', {wareId: '', wareNm: ''});
            uglcw.ui.get('.uglcw-grid:visible').reload();
        })
    ...
    function toTab(row) {
        uglcw.ui.openTab("审批详情-" + row.auditNo, "${base}/manager/toAuditDetailOperation?type=2&auditNo=" + row.auditNo)
    }
