        ...
        <div class="layui-card-body">
            <ul class="uglcw-query form-horizontal" id="export">
                ...
                <li>
                    ...
                    <input uglcw-role="textbox" uglcw-model="billNo" placeholder="权益单号">
                </li>
                <li>
    ...
    <div class="layui-card">
        <div class="layui-card-body full">
            <div id="grid" uglcw-role="grid"
                 uglcw-options="{
                    toolbar: kendo.template($('#toolbar').html()),
                     dblclick:function(row){
                       uglcw.ui.openTab('往来权益开单'+row.id, '${base}manager/showFinEquityEdit?billId='+ row.id+$.map( function(v, k){
                        return k+'='+(v||'');
                       }).join('&'));
                     },
                    ...
                    url: 'manager/queryFinEquityPage',
                    criteria: '.form-horizontal',
                       dataBound: function(){
                ...
                <div data-field="billNo" uglcw-options="width:160">权益单号</div>
                <div data-field="billTimeStr" uglcw-options="width:140">收款日期</div>
                <div data-field="proName" uglcw-options="width:130">往来单位</div>
                <div data-field="accName" uglcw-options="width:140">账户名称</div>
                <div data-field="totalAmt" uglcw-options="width:100">入股金额</div>
...
<script type="text/x-kendo-template" id="toolbar">
    <a role="button" href="javascript:newBill();" class="k-button k-button-icontext">
        <span class="k-icon k-i-plus-outline"></span>往来股东权益开单
    </a>
</script>
...
<script>
    ...
    function auditBill1(id) {
        uglcw.ui.confirm('您确认要审核吗？', function () {
            $.ajax({
                url: "manager/updateFinEquityAudit",
                type: "post",
                data: "billId=" + id,
    ...
    function newBill() {
        uglcw.ui.openTab('往来股东权益开单', '${base}manager/toFinEquityEdit')
    }
</script>
</body>
</html>
