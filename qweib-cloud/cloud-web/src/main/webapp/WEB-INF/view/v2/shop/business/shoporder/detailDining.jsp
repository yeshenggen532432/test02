        ...
        <div class="layui-col-md12">
            <div class="layui-card master">
                <div class="layui-card-header btn-group">
                    ...
                    <div class="bill-info">
                        <span class="status" style="color:green;">${orderStateMap[bforder.status]} - ${bforder.orderNo} - ${bforder.orderZt} </span>
                    </div>
                </div>
                <div class="layui-card-body">
                    <form class="form-horizontal" uglcw-role="validator">
                        ...
                        <div class="form-group" style="margin-bottom: 10px;">
                            ...
                            <div class="col-xs-4">
                                <input uglcw-role="textbox" id="zdzk" readonly uglcw-model="zdzk"
                                       title="商品净收入总额-商品总价"
                                       value="${bforder.zdzk}"/>
                            </div>
                            <label class="control-label col-xs-3">商品净收入总额</label>
                            <div class="col-xs-4">
                                <input uglcw-role="textbox" id="cjje" readonly uglcw-model="cjje" title="商品总价-促销总额-整单折扣"
                                       value="${bforder.cjje}"/>
                            </div>

                            <label class="control-label col-xs-3">订单实付</label>
                            <div class="col-xs-4">
                                <input uglcw-role="textbox" id="freight" uglcw-model="freight" style="display:none"
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        ">产品名称
                                ...
                                <div data-field="xsTp"
                                     uglcw-options="hidden:true,width: 120, editor: function(container, options){
                                       var rowIndex = $(container).closest('tr').index();
                                        var cellIndex = $(container).index();
...
<script>
    ...
    function calTotalAmount() {
        ...
        var zdzk = uglcw.ui.get("#zdzk").value();
        cjje = cjje - zdzk || 0;
