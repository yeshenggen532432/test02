            ...
            <div class="layui-card">
                <div class="layui-card-body full">
                    <div id="grid" uglcw-role="grid"
                        ...
                        responsive:[40],
                        id:'id',
                        url: '${base}manager/queryIncomeTypeList',
                        click:function(row){
                            uglcw.ui.bind('.query', {typeId: row.id});
        ...
        <div class="uglcw-layout-container">
            ...
            <div class="layui-card">
                <div class="layui-card-body full">
                    ...
                    id:'id',
                    url: '${base}manager/queryIncomeItemList',
                    criteria: '.query',
                    rowNumber:true,
                    }">
                        <div data-field="itemName" uglcw-options="width:120">明细科目名称</div>
                        <div data-field="mark"
                             uglcw-options="width:120,template: uglcw.util.template($('#formatterMark').html())">
                            默认类型
                        </div>
...
<script type="text/x-kendo-template" id="toolbar_cost">
    ...
    <a role="button" href="javascript:updateIncomeItemStatus(1);" class="k-button k-button-icontext">
        <span class="k-icon k-i-checkmark"></span>启用</a>
    <a role="button" href="javascript:updateIncomeItemStatus(0);" class="k-button k-button-icontext">
    ...
    <div class="layui-card">
        <div class="layui-card-body">
            <div class="form-horizontal" uglcw-role="validator" id="itemdlg">
                ...
                <div class="form-group">
                    <label class="control-label col-xs-8">设为默认</label>
                    <div class="col-xs-14">
                        <select uglcw-role="combobox" uglcw-model="mark" id="mark">
                            <option></option>
...
<script>
    ...
    */
        ...
        uglcw.ui.Modal.open({
            ...
            yes: function (container) {
                ...
                if (valid) {
                    ...
                    $.ajax({
                        url: '${base}/manager/saveFinIncomeItem',
                        type: "post",
                        data: data,
                        success: function (json) {
                            if (json.state) {
    ...
    function updateIncomeItemStatus(status) {
        validate(function (row) {
            $.ajax({
                url: "${base}manager/updateIncomeItemStatus",
   ...
   */
    function addTemplate() {
        uglcw.ui.openTab('项目参考数据', '${base}manager/toFinIncomeItemTemplate');
