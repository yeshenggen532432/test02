            ...
            <div id="grid" uglcw-role="grid"
                ...
                <div data-field="qty"
                     ...
                     footerTemplate: '#= uglcw.util.toString(data.qty || 0, \'n2\')#',
                        headerTemplate: uglcw.util.template($('#sort_js').html())({data:{title:'qty'}})">单据数量
                </div>
...
<script type="text/x-kendo-template" id="toolbar">
    ...
    <span style="color:red">
        注：按销售单查询时，发货数量与时间区间无关，只表示该客户对应发票的累计发货数
    </span>
</script>
...
<tag:exporter-complex service="customerSaleStatService" method="statPages"
                      bean="com.qweib.cloud.biz.erp.report.query.CustomerSaleStatQuery"
                      condition=".query" description="客户销售统计表"
/>
