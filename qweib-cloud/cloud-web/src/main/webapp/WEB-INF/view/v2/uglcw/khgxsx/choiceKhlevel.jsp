...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<table id="datagrid" class="easyui-datagrid" fit="true" singleSelect="true"
			url="manager/querySysKhlevel" title="客户等级列表" iconCls="icon-save" border="false"
		...
		<div id="tb" style="padding:5px;height:auto">
		    名称: <input name="khdjNm" id="khdjNm" style="width:120px;height: 20px;" onkeydown="toQuery(event);"/>
		...
		<script type="text/javascript">
			...
			function tochoice(index){
				...
				if (row){
				  window.parent.setKhlevel(row.id,row.khdjNm);
				}
			}
		</script>
	</body>
