    ...
    <div class="layui-card header">
        <div class="layui-card-body">
            <ul class="uglcw-query form-horizontal query">
                <li>
                    <input type="hidden" uglcw-model="khdjNm" value="${khdjNm}" uglcw-role="textbox">
    ...
    <div class="layui-card">
        <div class="layui-card-body full">
            <div id="grid" uglcw-role="grid"
                ...
                <div data-field="address" uglcw-options="width:245,tooltip: true">地址</div>
                ...
                <div data-field="longitude" uglcw-options="width:160">经度</div>
                <div data-field="latitude" uglcw-options="width:160">纬度</div>
...
<script>
  ...
  /*  function setWarePrice(id, name) {
    ...
    function showCustomers(id, name) {
        uglcw.ui.openTab(name + "_客户信息列表", "${base}manager/toCustomerLevelPage?_sticky=v2&khdjNm=" + name);
    }
*/
