            ...
            <div class="layui-card master">
                <div class="layui-card-header btn-group">
                    <ul uglcw-role="buttongroup">
                        ...
                        <span style="color: red">金额负数时，核算股东退投资款</span>
                    </ul>
                    <div class="bill-info">
                        ...
                        '
                            >
                                <div data-field="typeName"
                                     uglcw-options="width: 120,editable: false, footerTemplate: '合计:'">权益科目
                                </div>
                ...
                <div class="layui-col-md5">
                    <div class="layui-row layui-col-space5">
                        <div class="layui-col-md4">
							...
							url:'${base}manager/queryEquityTypeList?typeName=实收资本',
                        ...
                        <div class="layui-col-md8">
                            <div class="layui-card">
                                <div class="layui-card-body full">
                                   ...
                                   responsive:['.master',40],
                                    url:'${base}manager/queryUseEquityItemList?typeName=实收资本',
                                    criteria: '.query',
...
<tag:costitem-selector-template  typeQuery="setParamFun"  query="setParamFunSub"  typeUrl="${base}manager/queryEquityTypeList" url="${base}manager/queryUseEquityItemList"/>
...
<script>
    ...
    function add() {
        uglcw.ui.openTab('往来权益开单', '${base}manager/toFinEquityEdit?r=' + new Date().getTime());
    }
    ...
    function audit() {
        ...
        uglcw.ui.confirm('是否确定审核？', function () {
            uglcw.ui.loading();
            $.ajax({
                url: '${base}manager/updateFinEquityAudit',
                type: 'post',
