    ...
    <div class="layui-card header">
        <div class="layui-card-body">
            <ul class="uglcw-query">
                ...
                <li>
                    <select uglcw-role="combobox" uglcw-model="inType" uglcw-options="value: '${inType}'" placeholder="入库类型" disabled>
                ...
                <li>
                    <select uglcw-role="combobox" uglcw-model="billStatus" placeholder="发票状态" uglcw-options="value:''" >
...
<script id="op-tpl" type="text/x-uglcw-template">
    ...
    <c:if test="${permission:checkUserButtonPdm('stk.stkCome.items')}">
        ...
        <c:if test="${permission:checkUserButtonPdm('stk.stkCome.shouhuo')}">
            <button class="k-button k-success" onclick="showCheck(#= data.id#,'#= data.inType#','#=data.billStatus#','#=data.openZfjz#')">
                收货
            </button>
        </c:if>
        #}#
...
<script>
    ...
    function showDetail(id, status) {
        uglcw.ui.openTab('发票信息' + id, '${base}manager/showstkin?billId=' + id);
    }
    function showZfjzDetail(id) {
        uglcw.ui.openTab('发票信息' + id, '${base}manager/stkExtrasCarryOver/show?billId=' + id);
    }
