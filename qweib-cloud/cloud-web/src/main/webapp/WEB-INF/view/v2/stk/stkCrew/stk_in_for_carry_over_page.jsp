    ...
    <div class="layui-card">
        <div class="layui-card-body full">
            <div id="grid" uglcw-role="grid"
                ...
                <div data-field="inDate" uglcw-options="width:140">日期</div>
                ...
                <div data-field="op" uglcw-options="width:120, template: uglcw.util.template($('#opt-tpl').html())">操作</div>
                ...
                <div data-field="disAmt" uglcw-options="width:100, hidden:!${permission:checkUserFieldPdm('stk.stkIn.lookamt')}, footerTemplate: '#= data.disAmt#'">金额
                </div>
