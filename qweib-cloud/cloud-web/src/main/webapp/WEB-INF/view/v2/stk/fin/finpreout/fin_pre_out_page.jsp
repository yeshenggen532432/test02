        ...
        <div class="layui-card-body">
            <ul class="uglcw-query form-horizontal" id="export">
                <li>
                    ...
                    <input uglcw-role="textbox" uglcw-model="billNo" placeholder="预付单号">
                </li>
                <li>
            ...
            <div id="grid" uglcw-role="grid"
                 uglcw-options="{
                    ...
                    dblclick:function(row){
                       uglcw.ui.openTab('往来预付信息'+row.id, '${base}manager/showFinPreOutEdit?billId='+ row.id+$.map( function(v, k){
                        return k+'='+(v||'');
                       }).join('&'));
                     },
                ...
                <div data-field="billNo" uglcw-options="width:160">预付单号</div>
                ...
                <div data-field="totalAmt" uglcw-options="width:100">预付金额</div>
                <div data-field="payAmt" uglcw-options="width:100">已抵扣金额</div>
                <div data-field="backAmt" uglcw-options="width:100">回款金额</div>
        ...
        <div class="layui-card-body">
            <div class="form-horizontal  proceeds" uglcw-role="validator">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-14">
                        <input uglcw-validate="required" id="ioAmt" uglcw-role="numeric" onchange="changeAmt(this,'itemGrid')"
                               uglcw-model="ioAmt">
                    </div>
                </div>
                <div class="form-group">
...
<script type="text/x-kendo-template" id="toolbar">
    <a role="button" href="javascript:newBill();" class="k-button k-button-icontext">
        <span class="k-icon k-i-plus-outline"></span>往来预付开单
    </a>

    <a role="button" href="javascript:showPayStat();" class="k-button k-button-icontext">
        <span class="k-icon k-i-zoom"></span>预付款统计
    </a>
...
<script type="text/x-kendo-template" id="formatterSt3">
    ...
    # if(data.status =='0'){ #
    <button class="k-info k-button" onclick="auditBill1(#= data.id#, 1)"><i class="k-icon"></i>审核</button>
    # } #

    # if(data.totalAmt > (data.payAmt+data.backAmt+data.freeAmt)&&data.status==1){ #
    ...
    # if(data.backAmt >0||data.freeAmt>0){ #
    <button class="k-button k-info" onclick="showDetail(#= data.id#)">回款明细<i class="k-icon"></i>
    </button>
    # } #
</script>
...
<script>
            ...
            yes: function (container) {
                ...
                if (valid) {
                    ...
                    uglcw.ui.confirm('是否确定核销?', function () {
                        $.ajax({
                            url: '${base}/manager/updateFinPreOutFreeAmt',
                            data: data,
                            type: 'post',
    ...
    function showDetail(billId) {
        uglcw.ui.openTab('预付回款明细', '${base}manager/toFinPreOutRecPage?billId='+billId);
    }


    function showPayStat() {
        uglcw.ui.openTab('预付款统计', '${base}manager/toFinPreOutUnitStat?dataTp=1')

    }

    function newBill() {
        uglcw.ui.openTab('往来预付开单', '${base}manager/toFinPreOutEdit')
    ...
    function checkInItems(row,sumId,gridId) {
        ...
        var url = "${base}/manager/queryPreOutSubToReturnByBillId";
        $.ajax({
            url: url,
