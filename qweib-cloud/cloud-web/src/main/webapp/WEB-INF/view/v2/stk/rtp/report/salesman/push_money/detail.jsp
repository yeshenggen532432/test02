    ...
    <div class="layui-card header">
        <div class="layui-card-body">
            <ul class="uglcw-query form-horizontal">
                ...
                <li>
                    <input uglcw-role="textbox" uglcw-model="wareName" value="${wareName}" placeholder="品名"/>
                </li>
                <li>
                    <input type="hidden" uglcw-role="textbox" uglcw-model="wareTypeId" value="${wareTypeId}" />
        ...
        <div class="layui-card-body full">
            <div id="grid" uglcw-role="grid"
                 uglcw-options="
                    ...
                    url: '${base}manager/report/salesman/push_money/detail',
                    ...
                    dblclick: function(row) {
                        uglcw.ui.openTab('提成商品详情', '${base}manager/report/salesman/push_money/ware/page?salesmanId=' + row.salesmanId
                         + '&timeType=' + uglcw.ui.get('#timeType').value() + '&billType=' + row.billType
                         + '&salesmanName=' + row.salesmanName + '&configType=' + uglcw.ui.get('#type').value()
                         + '&customerId=' + row.customerId + '&customerName=' + row.customerName
                         + '&wareId=' + row.wareId + '&wareName=' + row.wareName
...
<script>
    ...
    $(function () {
        ...
        uglcw.ui.get('#reset').on('click', function () {
            uglcw.ui.clear('.form-horizontal', {beginDate: '${beginDate}', endDate: '${endDate}'});
        })
