...
<div id="printcontent" style="width:100%;text-align: center">
    ...
    <table style="padding-left: 30px;width: 95%;border-collapse: collapse;">
        ...
        <tr>
            ...
            <td class="unitName" style="width:120px;text-align: center;border:1px solid #000000;">计量单位</td>
            ...
            <td class="minUnitName" style="width:100px;text-align: center;border:1px solid #000000;">计量单位(小)</td>
        ...
        <c:forEach items="${datas}" var="item" varStatus="s">
            <tr>
                ...
                <td class="unitName" style="border:1px solid #999999;">${item.unitName}</td>
                ...
                <td class="minUnitName" style="border:1px solid #999999;">${item.minUnitName}</td>
...
<script>
    ...
    function filterField(){
        ...
        if(timeType==1){
            ...
            if('${query.filterDataType}'==2||'${query.filterDataType}'==3){
                $(".minQty").show();
            }
        }
    }
