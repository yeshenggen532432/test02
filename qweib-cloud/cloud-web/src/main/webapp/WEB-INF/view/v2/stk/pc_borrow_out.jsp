        ...
        <form class="form-horizontal" uglcw-role="validator">
            <div class="layui-card-body">
                ...
                <div class="form-group">
                    ...
                    <label class="control-label col-xs-5 col-xs-3">借出仓库</label>
    ...
    <div class="layui-card">
        <div class="layui-card-body full">
            ...
            >
                ...
                <div data-field="qualityDays" uglcw-options="width:100,editable: true">有效期
                </div>
...
<script>
    ...
    function add() {
        uglcw.ui.openTab('借出单', '${base}manager/pcborrowstkout?billId=0&r=' + new Date().getTime());
    }
    ...
    function auditProc() {
        ...
        uglcw.ui.openTab('借出发货单', '${base}manager/showstkoutcheck?dataTp=1&billId=' + billId);
    }
    ...
    function toPrint() {
        ...
        top.layui.index.openTabsPage('${base}manager/showstkoutprint?billId=' + billId + '&fromFlag=0', '打印借出单据单');
    }
