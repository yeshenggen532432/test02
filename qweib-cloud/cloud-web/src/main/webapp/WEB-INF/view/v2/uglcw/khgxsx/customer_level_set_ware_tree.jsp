                ...
                <div class="layui-card-body">
                    <ul class="uglcw-query form-horizontal">
                        <li>
                            ...
                            <input type="hidden" uglcw-model="levelId" id="levelId" uglcw-role="textbox" value="${levelId}">
                ...
                <div class="layui-card-body full">
                    <div id="grid" uglcw-role="grid"
                         uglcw-options="
							...
							pageable: true,
							rowNumber:true,
                    		url: '${base}manager/customerLevelSetWarePage',
...
<script id="header_lsPrice" type="text/x-uglcw-template">
    <span onclick="javascript:operatePrice('lsPrice');">大单位原价✎</span>
</script>
...
<script id="header_minLsPrice" type="text/x-uglcw-template">
    <span onclick="javascript:operatePrice('minLsPrice');">小单位原价✎</span>
</script>
...
<script id="type_rate_template" type="text/x-uglcw-template">
    #=item.text#
    #if(item.id!=0){#
    &nbsp;&nbsp;<span id="type_${levelId}_#= item.id#"></span>
    #}#
</script>
...
<script>
    ...
    function changePrice(o, field, wareId) {
        ...
        $.ajax({
            url: "${base}manager/updateCustomerLevelWarePrice",
            type: "post",
            data: "levelId=${levelId}&wareId=" + wareId + "&price=" + ipt + "&field=" + field,
