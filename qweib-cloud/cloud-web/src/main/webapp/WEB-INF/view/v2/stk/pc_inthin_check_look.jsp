				...
				<div class="layui-card-body">
					<form class="form-horizontal" uglcw-role="validator">
							...
							<div class="col-xs-4">
								<input uglcw-role="gridselector" value="${come.billNo}"
									   uglcw-options="click: function(){
											uglcw.ui.openTab('采购退货单据信息','${base}manager/showstkin?dataTp=1&billId=${come.inId}');
									   }">
							</div>
						...
						<div class="form-group">
							...
							<label class="control-label col-xs-5 col-xs-3">退货仓库</label>
							<div class="col-xs-4">
			...
			<div class="layui-card">
				<div class="layui-card-body full">
					...
					>
						...
						<div data-field="productDate" uglcw-options="width: 150">生产日期</div>
						<div data-field="qty" uglcw-options="width: 150, footerTemplate: '#= sum#'">单据数量</div>
						<div data-field="inQty" uglcw-options="width: 150, footerTemplate: '#= sum#'">退货数量</div>
					</div>
				</div>
			</div>
		</div>
