                ...
                <div class="layui-card-body">
                    <form class="form-horizontal" uglcw-role="validator">
                        ...
                        <div class="form-group" style="display: none;">
                            ...
                            <label class="control-label col-md-3">回库金额</label>
                            <div class="col-md-4">
            ...
            <div class="layui-card">
                <div class="layui-card-body full">
                    <div id="grid" uglcw-role="grid"
                         ...
                         responsive:[".master",40],
                          ...
                          aggregate: [
                            ...
                            {field: "maxQty", aggregate: "sum"},
                            {field: "amt", aggregate: "sum"}
                          ],
                           loadFilter: function(datas){
                              $(datas).each(function(idx, row){
                                if(row.hsNum!=0&&row.beUnit=="S"){
                                 var maxQty = parseFloat(row.qty)/parseFloat(row.hsNum);
                                  row.maxQty = maxQty.toFixed(2);
                                }else{
                                  row.maxQty =row.qty;
                                }
                             });
                    ...
                    >
                        ...
                        <div data-field="hsNum" uglcw-options="width: 120,hidden:true">换算数量</div>
                        ...
                        <div data-field="maxQty" uglcw-options="width: 100,
                             aggregates: ['sum'],
                            editable: false,
                            footerTemplate: '#= uglcw.util.toString((sum || 0), \'n2\')#'
                        ">回库数量(大)
                        </div>
                        <div data-field="wareDw" uglcw-options="width: 80">单位(大)</div>
        ...
        uglcw.ui.get('#grid').k().dataSource.bind('change', function (e) {
            ...
            if (action === 'itemchange') {
                ...
                if ((e.field === 'qty' || e.field === 'price')) {
                    ...
                    if(item.hsNum!=0&&item.beUnit=='S'){
                        var maxQty = parseFloat(item.qty)/parseFloat(item.hsNum);
                        //row.maxQty = maxQty.toFixed(2);
                        item.set('maxQty',maxQty.toFixed(2));
                    }else{
                        item.set('maxQty',item.qty);
                    }
