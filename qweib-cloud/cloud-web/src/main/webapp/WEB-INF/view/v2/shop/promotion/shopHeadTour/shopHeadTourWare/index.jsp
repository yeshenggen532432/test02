...
<div class="layui-fluid">
    ...
    ">
                ...
                <div>
                    <iframe data-src="${base}/manager/shopHeadTourWare/torunningpage" width="100%" frameborder="0"
                            allowtransparency="true"></iframe>
                </div>
                <div>
                    <iframe data-src="${base}/manager/shopHeadTourWareShare/torunningpage" width="100%" frameborder="0"
                            allowtransparency="true"></iframe>
                </div>
            </div>
        </div>
