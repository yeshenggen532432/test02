        ...
        <div class="layui-card-body full">
            <div id="grid" uglcw-role="grid"
                 uglcw-options="{
                    ...
                    url: '${base}/manager/finInitWlYwMain/page',
                    rowNumber: true,
                ...
                <div data-field="_operator"
                     uglcw-options="width:140, template: uglcw.util.template($('#formatterSt').html())">操作
                </div>
...
<script>
    ...
    function toUpCustomer() {//上传数据
        uglcw.ui.Modal.showUpload({
            url: '${base}manager/finInitWlYwMain/toUpCustomerInitAmt?bizType=${bizType}',
            field: 'upFile',
            error: function (e) {
                uglcw.ui.notice({
                    type: 'error',
