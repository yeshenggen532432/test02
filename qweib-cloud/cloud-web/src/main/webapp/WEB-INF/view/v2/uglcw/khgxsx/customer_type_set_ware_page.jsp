...
<html>
	...
	<body>
		...
		<div id="tb" style="padding:5px;height:auto">
			...
			<input type="hidden" name="relaId" id="relaId" value="${relaId}"/>
		...
		<script type="text/javascript">
		 function initGrid()
		    {
				...
				cols2.push(col);
				$('#datagrid').datagrid({
					url:"manager/customerTypeSetWarePage",
					queryParams:{
						wareNm:$("#wareNm").val(),
						wtype:'${wtype}',
						relaId:'${relaId}'
		 ...
		 function changePrice(o,field,wareId){
			 $.ajax({
				 url: "manager/updateCustomerTypeWarePrice",
				 type: "post",
				 data: "relaId=${relaId}&wareId=" + wareId + "&price=" + o.value+"&field="+field,
