        ...
        <div class="layui-card-body full">
            <div id="grid" uglcw-role="grid"
                 uglcw-options="
							...
							id:'id',
							pageable: true,
                    		url: '${base}manager/pos/queryPosDisSet',
                    		criteria: '.query',
                    	">
                <div data-field="rateType" uglcw-options="width:150,template: uglcw.util.template($('#rateType').html())">
                    打折类型
                </div>
    ...
    <div class="layui-card">
        <div class="layui-card-body">
            <form class="form-horizontal" uglcw-role="validator">
                ...
                <div class="form-group">
                    <label class="control-label col-xs-6" for="dialog-status">有&nbsp;&nbsp;效&nbsp;&nbsp;否</label>
                    <div class="col-xs-16">
    ...
    function edit(row) {
        uglcw.ui.Modal.open({
            ...
            yes: function (container) {
                ...
                uglcw.ui.loading();
                $.ajax({
                    url: '${base}manager/pos/savePosDisSet',
                    type: 'post',
                    data: {
                        id: id,
                        shopNo: shopNo,
