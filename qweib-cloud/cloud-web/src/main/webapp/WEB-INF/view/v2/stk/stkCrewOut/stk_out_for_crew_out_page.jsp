...
<div class="layui-card header" style="margin-bottom: 0px;">
    <div class="layui-card-body">
        <ul class="uglcw-query">
            ...
            <li>
                <input class="k-textbox" uglcw-role="textbox" uglcw-model="epCustomerName" placeholder="所属二批">
            </li>
            <li>
...
<script>
    ...
    function add(billId) {
        uglcw.ui.openTab('商品出仓单', '${base}manager/stkCrewOut/add?sourceId='+billId);
    }
