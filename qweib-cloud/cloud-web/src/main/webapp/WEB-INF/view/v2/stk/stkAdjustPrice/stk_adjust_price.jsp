        ...
        <div class="layui-card-body">
            <form class="form-horizontal" uglcw-role="validator">
                ...
                <div class="col-xs-4">
                    ...
                    <div id="proName3_div" style="display: none">
                    <select uglcw-role="combobox" id="proName3" uglcw-model="proName3" uglcw-options="
                    ...
                    <div  id="proName4_div" style="display:none;">
                    <select uglcw-role="combobox" id="proName4" uglcw-model="proName4" uglcw-options="
                                    url: '${base}manager/getCustomerLevelDatas',
                                    placeholder: '客户等级',
                    ...
                    <label class="control-label col-xs-3">生效日期</label>
                    <div class="col-xs-4" style="width: 110px;">
                        <input id="sdate" uglcw-role="datetimepicker" uglcw-options="format:'yyyy-MM-dd',
                     width:100"
                               uglcw-model="sdate" value="${stkAdjustPrice.sdate}">
                    </div>
                    <div class="col-xs-4" style="width:10px;">到</div>
                    <div class="col-xs-4" style="width: 110px;">
                        <input id="edate" uglcw-role="datetimepicker" width="100px" uglcw-options="format:'yyyy-MM-dd'"
                               uglcw-model="edate" value="${stkAdjustPrice.edate}">
                    </div>
...
<script>
    $(function () {
        ...
        uglcw.ui.get('#proName3').on('change', function(){
            $("#proName").val(this.text());
            $("#proId").val(this.value());
            $("#proName4").data("kendoComboBox").text('');
            $("#proName4").data("kendoComboBox").value('');
            $("#proName2").val("");
        });
        uglcw.ui.get('#proName4').on('change', function(){
            $("#proName").val(this.text());
            $("#proId").val(this.value());
            $("#proName3").data("kendoComboBox").text('');
            $("#proName3").data("kendoComboBox").value('');
            $("#proName2").val("");
        });
        ...
        if('${stkAdjustPrice.proType}'==0){
            ...
            $("#proName3_div").show();
            $("#proName4_div").hide();
            $("#proName3").data("kendoComboBox").text('${stkAdjustPrice.proName}');
            $("#proName3").data("kendoComboBox").value('${stkAdjustPrice.proId}');
        }else if('${stkAdjustPrice.proType}'==4){
            $("#proName2_div").hide();
            $("#proName3_div").hide();
            $("#proName4_div").show();
            $("#proName4").data("kendoComboBox").text('${stkAdjustPrice.proName}');
            $("#proName4").data("kendoComboBox").value('${stkAdjustPrice.proId}');
        }
    });
    ...
    function drageSave() {//暂存
        ...
        if(form.sdate==""||form.sdate==null||form.edate==""||form.edate==null){
            return uglcw.ui.error('生效日期不能位空!');
        }
