    ...
    <div class="layui-card header">
        <div class="layui-card-body">
            <ul class="uglcw-query form-horizontal" id="export">
                <li>
                    <input uglcw-model="sdate" uglcw-role="datepicker" value="">
                </li>
                <li>
        ...
        <div class="layui-card-body full">
            <div id="grid" uglcw-role="grid"
                 uglcw-options="{
                    ...
                    toolbar: kendo.template($('#toolbar').html()),
                     dblclick:function(row){
                       uglcw.ui.openTab('往来借出单'+row.id, '${base}manager/showFinOutEdit?billId='+ row.id+$.map( function(v, k){
                        return k+'='+(v||'');
                       }).join('&'));
                     },
                    id:'id',
                ...
                <div data-field="_operator"
                     uglcw-options="width:160, template: uglcw.util.template($('#formatterSt3').html())">操作
                </div>
...
<script type="text/x-kendo-template" id="toolbar">
    <a role="button" href="javascript:newBill();" class="k-button k-button-icontext">
        <span class="k-icon k-i-plus-outline"></span>往来借出开单
    </a>

    <a role="button" href="javascript:showPayStat();" class="k-button k-button-icontext">
        <span class="k-icon k-i-zoom"></span>借出统计
    </a>
...
<script>
    ...
    function showPayStat() {
        uglcw.ui.openTab('借出统计', '${base}/manager/toFinOutStat?dataTp=1')
