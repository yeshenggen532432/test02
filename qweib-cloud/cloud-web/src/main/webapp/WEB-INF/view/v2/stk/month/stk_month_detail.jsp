            ...
            <div class="layui-card">
                <div class="layui-card-body full">
                    ...
                    ">
                        ...
                        <div data-field="checkInQty"
                             uglcw-options="width: 100,hidden: ${!fn:contains(fieldsStr, '销售金额')}, format: '{0:n2}', footerTemplate: '#= uglcw.util.toString(data.checkInQty,\'n2\')#'">
                            销售金额
                        </div>
                        ...
                        <div data-field="outAmt15"
                             uglcw-options="width: 120,hidden: ${!fn:contains(fieldsStr, '其它销售金额') or isExpand == 0},  format: '{0:n2}', footerTemplate: '#= uglcw.util.toString(data.outAmt15,\'n2\')#'">
                            其它销售金额
                        </div>
                        ...
                        <div data-field="shopSaleAmt"
                             uglcw-options="width: 120,hidden: ${!fn:contains(fieldsStr, '终端零售金额') or isExpand == 0}, format: '{0:n2}', footerTemplate: '#= uglcw.util.toString(data.shopSaleAmt,\'n2\')#'">
                            终端零售金额
                        </div>
                        ...
                        <div data-field="endAmt"
                             uglcw-options="width: 120, hidden: ${!fn:contains(fieldsStr, '期末金额')},format: '{0:n2}', footerTemplate: '#= uglcw.util.toString(data.endAmt,\'n2\')#'">
                            期末金额
                        </div>
        ...
        <div class="layui-card-body">
            <div style="padding: 10px; color: \\#444;">
                <input type="checkbox" uglcw-role="checkbox" uglcw-model="showAmt"
                       ...
                       uglcw-value="${showAmt}"
                       class="k-checkbox" id="showAmt">
                <label style="margin-bottom: 0px;" class="k-checkbox-label" for="showAmt">显示金额</label>
            ...
            success: function (c) {
                ...
                uglcw.ui.get('#showAmt').on('change', function () {
                    ...
                    $(c).find('.uglcw-grid .k-grid-content td').each(function () {
                        ...
                        if (title.indexOf('金额') !== -1 || title.indexOf('单价') !== -1) {
                            if (showAmt) {
                                grid.select(td.closest('tr'));
                            } else {
                                var lockedRow = $(c).find('.uglcw-grid .k-grid-content-locked tr[data-uid=' + td.closest('tr').data('uid') + ']');
                                var checkbox = lockedRow.find('input.k-checkbox');
