    ...
    <div class="layui-card header">
        ...
        <div class="layui-card-body full" style="padding-left: 5px;">
            <ul class="uglcw-query query">
                ...
                <li>
                    <input class="k-textbox" uglcw-role="textbox" uglcw-model="epCustomerName"
                           placeholder="所属二批">
                </li>
                <li>
                    <select uglcw-model="outType" uglcw-role="combobox"
                            uglcw-options=" placeholder:'出库类型',value: '${outType}'"
                            id="outType" disabled>
                ...
                <%--<li>--%>
                    <%--<select uglcw-model="pszd" id="pszd" uglcw-role="combobox" uglcw-options="placeholder:'配送指定', value: ''">--%>
    ...
    <div class="layui-card">
        <div class="layui-card-body full">
            <div id="grid" uglcw-role="grid" class="uglcw-grid-compact"
                ...
                <div data-field="outDate" uglcw-options="width:140">单据日期</div>
