	...
	<div class="layui-card">
		<div class="layui-card-body full">
			...
			<div id="grid" uglcw-role="grid"
				 uglcw-options="{
                    ...
                    loadFilter: {
                     ...
                     dblclick:function(row){
                       uglcw.ui.openTab('往来预付款信息', '${base}manager/showFinPreOutEdit?billId='+ row.id);
                     },

                    id:'id',
                    url: 'manager/queryFinPreOutPage1',
                    criteria: '.form-horizontal',

                    }">
				<div data-field="billNo" uglcw-options="width:160">往来单位</div>
				...
				<div data-field="needPay" uglcw-options="width:140">剩余预付</div>
