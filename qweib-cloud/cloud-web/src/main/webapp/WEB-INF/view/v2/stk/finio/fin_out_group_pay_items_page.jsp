    ...
    <div class="layui-card">
        <div class="layui-card-body full">
            <div id="grid" uglcw-role="grid"
                ...
                <div data-field="billNo" uglcw-options="width:160">回款单号</div>
                ...
                <div data-field="totalAmt" uglcw-options="width:100">回款金额</div>
                <div data-field="needPay"
                     uglcw-options="width:100,footerTemplate:'#= uglcw.util.toString(data.needPay,\'n2\')#'">
                    未回款金额
                </div>
                <div data-field="payAmt" uglcw-options="width:100">已回金额</div>
