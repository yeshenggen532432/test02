...
<div class="layui-fluid">
    ...
    ">
                ...
                <div>
                    <iframe data-src="${base}/manager/shopHeadTourWare/topage" width="100%" frameborder="0"
                            allowtransparency="true"></iframe>
                </div>
                <div>
                    <iframe data-src="${base}/manager/shopHeadTourPlan/topage" width="100%" frameborder="0"
                            allowtransparency="true"></iframe>
                </div>
            </div>
        </div>
