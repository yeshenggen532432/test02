            ...
            <div id="grid" uglcw-role="grid"
                 uglcw-options="
                      ...
                      if(amtType !=''){
                        ...
                        q.amtType = amtType;
                         uglcw.ui.openTab('往来单位借款统计', '${base}manager/toFinInUnitStat?'+ $.map(q, function(v, k){
                         return k+'='+(v);
                        }).join('&'));
                       }
                     },
                ...
                <div data-field="itemName1" uglcw-options="width:200"></div>
                <div data-field="amt1"
                     uglcw-options="width:200, template: uglcw.util.template($('#colour').html())"></div>
