					...
					<div class="layui-card-body">
						<div class="form-horizontal query">
							<div class="form-group" style="margin-bottom: inherit;">
								<div class="col-xs-4">
									<input uglcw-model="ztNm" uglcw-role="textbox" placeholder="经销商状态名称">
								</div>
								<div class="col-xs-4">
			...
			<div class="layui-card">
				<div class="layui-card-body full">
                    ...
                    pageable: true,
                        ...
                        "></div>
						<div data-field="ztNm" uglcw-options="attributes:{style:'text-align:center'},headerAttributes:{style:'text-align:center'}">
							经销商状态名称</div>
					</div>
				</div>
			</div>
...
<script type="text/x-kendo-template" id="toolbar">
	<a role="button" href="javascript:toaddJxszt();" class="k-button k-button-icontext">
		...
		<div class="layui-card-body">
			<div class="form-horizontal" uglcw-role="validator" id="bind">
				<div class="form-group">
					...
					<label class="control-label col-xs-8">经销商级别名称</label>
					<div class="col-xs-14">
						<input class="form-control" uglcw-role="textbox" uglcw-model="ztNm" uglcw-validate="required">
					</div>
				</div>
			</div>
		</div>
...
<script>
	...
	function toDel() {   //删除
		var selection = uglcw.ui.get('#grid').selectedRow();
		if (selection) { //判断是否为空
			uglcw.ui.confirm('是否要删除选中的经销商状态?', function () {
				$.ajax({
					url: '${base}/manager/deleteJxsztById',
					data: {
						id: selection[0].id
					},
					type: 'post',
