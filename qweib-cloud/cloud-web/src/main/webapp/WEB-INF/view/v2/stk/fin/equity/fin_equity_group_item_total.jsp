                ...
                <div class="layui-card-body full">
					...
					loadFilter: {
                      ...
                      dblclick:function(row){
                       ...
                       uglcw.ui.openTab('股东权益收款明细', '${base}manager/toEquityStatItemPage?'+ $.map(q, function(v, k){
                        return k+'='+(v||'');
                       }).join('&'));
                     },
                     responsive:['.header',40],
                    id:'id',
                    url: 'manager/queryEquityGroupItemPage',
                    pageable: true,
                    rowNumber: true,
                    criteria: '.form-horizontal',
                     ...
                     {field: 'totalAmt', aggregate: 'SUM'}
                        ...
                        <div data-field="totalAmt"
                             uglcw-options="width:200, format: '{0:n2}',footerTemplate: '#= uglcw.util.toString(data.totalAmt,\'n2\')#'">
                            投资金额
                        </div>
                    </div>
                </div>
