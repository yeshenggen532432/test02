...
<div class="layui-fluid">
    ...
    ">
                ...
                <div>
                    <iframe data-src="${base}/manager/stkInvoice/toStkOutPageForInvoice" width="100%" frameborder="0"
                            allowtransparency="true"></iframe>
                </div>
                <div>
                    <iframe data-src="${base}/manager/stkInvoice/toPage" width="100%" frameborder="0"
                            allowtransparency="true"></iframe>
                </div>
            </div>
        </div>
