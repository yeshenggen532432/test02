...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<table id="datagrid" class="easyui-datagrid" fit="true" singleSelect="true"
			url="manager/querySysSctype" title="市场类型列表" iconCls="icon-save" border="false"
		...
		<div id="tb" style="padding:5px;height:auto">
		    名称: <input name="sctpNm" id="sctpNm" style="width:120px;height: 20px;" onkeydown="toQuery(event);"/>
		...
		<script type="text/javascript">
			...
			function tochoice(index){
				...
				if (row){
				  window.parent.setSctype(row.id,row.sctpNm);
				}
			}
		</script>
	</body>
