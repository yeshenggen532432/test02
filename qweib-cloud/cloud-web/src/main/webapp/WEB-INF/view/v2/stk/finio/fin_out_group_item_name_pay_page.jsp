            ...
            <div id="grid" uglcw-role="grid"
                 uglcw-options="{
                     ...
                     dblclick:function(row){
                       ...
                       uglcw.ui.openTab(q.itemName+'_待回款单据', '${base}manager/toOutGroupPayItemsPage?'+$.map(q, function(v, k){
                        return k+'='+(v||'');
                       }).join('&'));
                     },
                      responsive:['.header',40],
                    id:'id',
                    url: 'manager/queryOutGroupItemNamePayPage',
