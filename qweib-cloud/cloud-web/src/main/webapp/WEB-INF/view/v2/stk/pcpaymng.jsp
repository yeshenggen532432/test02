    ...
    <div class="layui-card header">
        <li class="layui-card-body">
            <ul class="uglcw-query form-horizontal query">
                ...
                <li>
                        <input uglcw-role="numeric" style="width: 70px" data-min="0" uglcw-model="beginAmt" placeholder="单据金额">到<input uglcw-role="numeric"  style="width: 70px" uglcw-model="endAmt" placeholder="单据金额">
                </li>
                <li>
        ...
        <div class="layui-card-body full">
            <div id="grid" uglcw-role="grid"
                 uglcw-options="
                    ...
                    pageable: true,
                    ">
                <div data-field="billNo" uglcw-options="width:180,tooltip: true, footerTemplate: '合计'">单据单号</div>
                <div data-field="inDate" uglcw-options="width:150, format: '{0:n2}'">单据日期</div>
...
<script type="text/x-uglcw-template" id="toolbar">
    <a role="button" class="k-button k-button-icontext"
       href="javascript:showInfo();">
        <span class="k-icon k-i-search"></span>查看单据
    </a>
    <a role="button" class="k-button k-button-icontext"
            ...
            yes: function (container) {
                ...
                if (validator.validate()) {
                    ...
                    if(row.inType=='应付往来单位初始化'){
                        ...
                        url = '${base}manager/stkFixedFee/updateFixedFeeYfFreeAmt';
                    }
