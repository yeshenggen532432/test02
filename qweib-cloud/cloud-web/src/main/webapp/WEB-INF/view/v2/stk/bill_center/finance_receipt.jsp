...
<div class="layui-fluid">
    ...
    ">
                ...
                <div title="往来借入单">
                    <iframe data-src="${base}/manager/bill_center/finance/borrow" name="doneForm" id="doneForm" frameborder="0"
                            marginheight="0"
                            marginwidth="0" width="100%" height="100%"></iframe>
                </div>
                <div title="往来回款单">
                    <iframe data-src="${base}/manager/toFinOutReturnPage" name="notForm" id="notForm" frameborder="0"
                            marginheight="0"
                            marginwidth="0" width="100%" height="100%"></iframe>
                </div>
            </div>
