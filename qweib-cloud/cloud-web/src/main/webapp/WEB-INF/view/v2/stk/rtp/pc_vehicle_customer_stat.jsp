    ...
    <div class="layui-card header">
        <div class="layui-card-body">
            <ul class="uglcw-query form-horizontal">
                ...
                <%--</li>--%>
                <li>
                    <input uglcw-role="textbox" uglcw-model="vehNo" value="${vehNo}" placeholder="车牌号"/>
                </li>
                <li>
                    <input uglcw-role="textbox" uglcw-model="driverName" placeholder="送货人" value="${driverName}"/>
                </li>
                <li>
                    <input uglcw-role="textbox" uglcw-model="customerName" value="${customerName}" placeholder="客户名称"/>
                </li>
                <li>
                    <input uglcw-role="textbox" uglcw-model="wareNm" value="${wareNm}" placeholder="品名"/>
                </li>
                <li>
        ...
        <div class="layui-card-body full">
            <div id="grid" uglcw-role="grid"
                 uglcw-options="
                    ...
                    url: '${base}manager/queryVehicleCustomerStatPage',
                    ...
                    dblclick: function(row){
                        ...
                        uglcw.ui.openTab('车辆配送客户细项统计表', '${base}manager/queryVehicleCustomerItemStat?'+ $.map(q, function(v, k){
                            return k+'='+(v||'');
                        }).join('&'));
                    },
                    loadFilter: {
                ...
                <div data-field="tranAmt" uglcw-options="width: 100, format: '{0:n2}'">单位配送费用</div>
...
<script type="text/x-kendo-template" id="toolbar">
    <a role="button" href="javascript:editRptData();" class="k-button k-button-icontext">
        <span class="k-icon k-i-edit"></span>编辑车辆配送客户统计表
    </a>
</script>
...
<script>
    ...
    function editRptData() {
        ...
        uglcw.ui.openTab('编辑车辆配送客户统计表', "${base}manager/queryVehicleCustomerStatList?" + $.map(query, function (v, k) {
            return k + '=' + (v || '');
        }).join('&'));
    }
