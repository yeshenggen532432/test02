...
<script type="text/javascript">
    ...
    map.centerAndZoom(new BMap.Point(118.103886, 24.489231), 14);     // 初始化地图,设置中心点坐标和地图级别
    ...
    if (document.createElement('canvas').getContext) {  // 判断当前浏览器是否支持绘制海量点
        ...
        for (var i = 0; i < markerArr.length; i++) {
            ...
            if (b && b.indexOf("&") != -1) {
                ...
                //第一个为中心点
                if(i == 0){
                    map.centerAndZoom(new BMap.Point(p0, p1), 14);
                }
            }
        }
        var options = {
        ...
        initClickListener(pointCollection);
    } else {
    ...
    function initClickListener(pointCollection) {
