			...
			<div class="layui-card">
				<div class="layui-card-body full">
                    ...
                    ">
                        ...
                        "></div>
						<div data-field="wareCode" uglcw-options="width:160">商品编码</div>
						...
						<div data-field="wareDj" uglcw-options="width:160">大单位批发价</div>
						<div data-field="tranAmt" uglcw-options="width:160">单件运输费用</div>
						<div data-field="tcAmt" uglcw-options="width:160;hidden:true">单件提成费用</div>
...
<script type="text/x-kendo-template" id="toolbar">
	<a role="button" href="javascript:editPrice();" class="k-button k-button-icontext">
		<span class="k-icon k-i-download"></span>编辑价格
	</a>
</script>
