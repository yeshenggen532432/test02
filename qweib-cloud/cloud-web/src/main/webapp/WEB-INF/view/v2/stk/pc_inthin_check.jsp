		...
		<div class="layui-card-body">
			<form class="form-horizontal" uglcw-role="validator">
				...
				<div class="form-group">
					...
					<label class="control-label col-xs-3">退货货仓库</label>
					<div class="col-xs-4">
		...
		<div class="layui-card-body full">
						  ...
						  loadFilter:{
									data: function(datas){
									  ...
									  $.map(datas, function (data) {
												data.qty=data.qty*(-1);
												data.inQty=data.inQty*(-1);
												data.inQty1=data.inQty1*(-1);
												data.amt=data.amt*(-1);
			...
			>
				...
				<div data-field="inQty1" uglcw-options="
                            schema:{editable: true, type: 'number',decimals:10, validation:{required:true}},
                            width: 100
                            ">本次收货
				</div>
...
<script>
	...
	function auditProc() {
		...
		list = $.map(list, function (product) {
			...
			product.inQty = product.inQty1*(-1);
