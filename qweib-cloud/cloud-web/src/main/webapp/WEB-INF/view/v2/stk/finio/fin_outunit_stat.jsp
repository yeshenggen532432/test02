    ...
    <div class="layui-card">
        <div class="layui-card-body full">
            ...
            <div id="grid" uglcw-role="grid"
					...
					loadFilter: {
                      ...
                      aggregates: function (response) {
                        ...
                        var q = uglcw.ui.bind('.form-horizontal');
                         ...
                         delete q['titleName'];
                         delete q['ioType'];
                       uglcw.ui.openTab('供应商付款明细', '${base}manager/toFinOutUnitDetail?'+$.map(q,function(v, k){
                        return k+'='+(v||'');
                       }).join('&'));
                     },
                    id:'id',
                    url: 'manager/queryFinOutUnitStat',
                ...
                <div data-field="unitName" uglcw-options="width:120,footerTemplate: '合  计'">往来单位</div>
                <div data-field="sumAmt"
                     uglcw-options="width:120, format: '{0:n2}',footerTemplate: '#= uglcw.util.toString(data.sumAmt,\'n2\')#'">${titleName}
                </div>
            </div>
        </div>
    </div>
