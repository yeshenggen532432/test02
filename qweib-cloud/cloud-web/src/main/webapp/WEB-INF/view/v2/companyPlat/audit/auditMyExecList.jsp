                ...
                <div>
                    ...
                    <div id="grid0" uglcw-role="grid"
                         uglcw-options="
							...
							id:'id',
							pageable: true,
                    		url: '${base}manager/queryMyExecPage?isOver=2',
                    		criteria: '.query0',
                ...
                <div>
                    ...
                    <div id="grid1" uglcw-role="grid"
                         uglcw-options="
							...
							autoBind:false,
							pageable: true,
                    		url: '${base}manager/queryMyExecPage?isOver=1',
                    		criteria: '.query1',
                    		dblclick:function(row){
                    		    toTab(row)
                    		}
...
<script>
    ...
    function toTab(row) {
        uglcw.ui.openTab("审批详情-" + row.auditNo, "${base}/manager/toAuditDetailOperation?type=3&auditNo=" + row.auditNo)
    }
