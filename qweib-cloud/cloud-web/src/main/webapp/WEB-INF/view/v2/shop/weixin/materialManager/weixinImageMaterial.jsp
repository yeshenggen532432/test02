				...
				<div class="layui-card-body full">
					<div id="grid" uglcw-role="grid"
						 uglcw-options="
							...
							checkbox:true,
							pageable: true,
                    		url: '/manager/getMaterialList?type=image&total=${image_count}',
                    		criteria: '.form-horizontal',
                    	">
						<div data-field="media_id" uglcw-options="width:350,hidden: true">素材id</div>
						<div data-field="url" uglcw-options="width:300,template: uglcw.util.template($('#url').html())">图片</div>
						<div data-field="name" uglcw-options="width:150">名称</div>
						<div data-field="update_time" uglcw-options="width:170,template: uglcw.util.template($('#update_time').html())">更新日期</div>
...
<script id="del" type="text/x-uglcw-template">
	<button onclick="javascript:deleteImageMaterial('#= data.media_id#');" class="k-button k-error">删除</button>
</script>
