            ...
            <div id="grid" uglcw-role="grid"
                 uglcw-options="{
                    ...
                    dblclick: function(row){
                        uglcw.ui.openTab('销售成本'+row.id,'${base}manager/cost/stkCostPickup/show?billId='+row.fdId);
                    },
                    url: '${base}manager/cost/stkCostPickup/pages',
                    criteria: '.form-horizontal',
                     dataBound: function(){
                ...
                <div data-field="outAmt" uglcw-options="width:100">领料金额</div>
...
<script>
    ...
    function showSourceBillNo(id) {
        uglcw.ui.openTab('领料出库信息' + id, "${base}manager/stkPickup/show?dataTp=1&billId=" + id)
    }
    function waretype() {
