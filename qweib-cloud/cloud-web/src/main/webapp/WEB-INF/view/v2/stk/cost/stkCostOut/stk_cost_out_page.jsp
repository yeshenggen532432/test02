            ...
            <div id="grid" uglcw-role="grid"
                 uglcw-options="{
                    ...
                    dblclick: function(row){
                        uglcw.ui.openTab('销售成本'+row.id,'${base}manager/cost/stkCostOut/show?billId='+row.fdId);
                    },
                    url: '${base}manager/cost/stkCostOut/pages',
                    criteria: '.form-horizontal',
                     dataBound: function(){
                ...
                <div data-field="billType" uglcw-options="width:160,tooltip: true">出库类型</div>
                ...
                <div data-field="outAmt" uglcw-options="width:100">销售金额</div>
                ...
                <div data-field="ioBillNo" uglcw-options="width:140,
                             template: function(dataItem){
                           return kendo.template($('#io-bill-no').html())(dataItem)
                          }
                    ">关联发货单号</div>
                <div data-field="sourceBillNo" uglcw-options="width:140,
                                 template: function(dataItem){
                           return kendo.template($('#source-bill-no').html())(dataItem)}">关联单号</div>
...
<script id="io-bill-no" type="text/x-kendo-template">
    <a href="javascript:showIoBillNo(#= data.ioBillId#);" style="color:red;font-size: 12px; font-weight: bold;">#=data.ioBillNo#</a>
</script>
