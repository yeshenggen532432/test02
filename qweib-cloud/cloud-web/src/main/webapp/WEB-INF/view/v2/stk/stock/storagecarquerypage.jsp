...
<div id="tb" style="padding:5px;height:auto">
	...
	仓库:
	<tag:select name="wareStk" id="stkId" tableName="stk_storage" headerKey="" headerValue="--请选择--" whereBlock="sale_Car=1 and (status=1 or status is null)" displayKey="id" displayValue="stk_name"/>
