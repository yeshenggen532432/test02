    ...
    <div id="app">
        <div style="padding-bottom: 50px;">
            <i-form ref="form" :label-width="120" :model="shopTourWare" :rules="rules">
                ...
                <form-item  class="main-item"  label="结束时间到,人数未满订单" prop="count">
                    <input type="radio" v-model="shopTourWare.endTimeSuccess" value="0" onclick="showPreAmtDic()"/>无效
                    <input type="radio" v-model="shopTourWare.endTimeSuccess"  value="1" onclick="showPreAmtDic()"/>有效
                    <span style="padding-left: 10px;color: red;">无效时拼团时间结束后，拼团订单自动取消并自动退款用户，有效拼团自动完成。</span>
                </form-item>
