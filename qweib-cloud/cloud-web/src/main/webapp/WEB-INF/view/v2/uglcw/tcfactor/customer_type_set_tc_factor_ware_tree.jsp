                ...
                <div class="layui-card-body full">
                    <div id="grid" uglcw-role="grid"
                         uglcw-options="
							...
							pageable: true,
							rowNumber:true,
                    		url: '${base}manager/customerTypeTcFactorSetWarePage',
                        ...
                        <div data-field="saleQtyTc" uglcw-options="
								...
								template:function(row){
									return uglcw.util.template($('#price').html())({val:row.saleQtyTc, data: row, field:'saleQtyTc'})
								}
								">业务提成按数量</div>
...
<script>
    ...
    function changePrice(o, field, wareId) {
        ...
        $.ajax({
            url: "${base}manager/updateCustomerTypeWareTcFactor",
            type: "post",
    ...
    function setTypeFactors(rows){
        if(datas!=null&&datas!=""){
            $(rows).each(function(idx, row){
                ...
                if('${type}'==1&&(row.saleQtyTc==undefined||row.saleQtyTc==null||row.saleQtyTc==0.00)){
