...
<script>
    ...
    //下载
    function download() {
        uglcw.ui.confirm('是否下载客户价格模版？', function () {
            window.location.href = '${base}/static/template/customer_price.xlsx'
        })
    }
    ...
    function showUpload() {
        uglcw.ui.Modal.showUpload({
            url: '${base}manager/customer/price/import_data',
            field: 'uploadFile',
            error: function (e) {
                uglcw.ui.notice({
                    type: 'error',
