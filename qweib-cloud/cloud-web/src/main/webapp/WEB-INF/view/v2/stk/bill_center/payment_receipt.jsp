...
<div class="layui-fluid">
    ...
    ">
                ...
                <div title="已收款单">
                    <iframe data-src="${base}/manager/bill_center/payment/receipt/done" name="doneForm" id="doneForm" frameborder="0"
                            marginheight="0"
                            marginwidth="0" width="100%" height="100%"></iframe>
                </div>
                <div title="应收货款单">
                    <iframe data-src="${base}/manager/bill_center/payment/receipt/not" name="notForm" id="notForm" frameborder="0"
                            marginheight="0"
                            marginwidth="0" width="100%" height="100%"></iframe>
                </div>
            </div>
