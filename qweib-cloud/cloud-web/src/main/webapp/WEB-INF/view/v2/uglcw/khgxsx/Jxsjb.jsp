                    ...
                    <div class="layui-card-body">
                        <div class="form-horizontal query">
                            <div class="form-group" style="margin-bottom: inherit;">
                                <div class="col-xs-4">
                                    <input uglcw-model="jbNm" uglcw-role="textbox" placeholder="经销商级别名称">
                                </div>
                                <div class="col-xs-4">
        ...
        <div class="layui-card-body">
            <div class="form-horizontal" uglcw-role="validator" id="bind">
                <div class="form-group">
                    ...
                    <div class="col-xs-14">
                        <input class="form-control" uglcw-role="textbox" uglcw-model="jbNm" uglcw-validate="required">
                    </div>
                </div>
            </div>
        </div>
