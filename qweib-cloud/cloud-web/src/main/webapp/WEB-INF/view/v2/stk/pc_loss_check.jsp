				...
				<div class="layui-card-body">
					<form class="form-horizontal" uglcw-role="validator">
						...
						<div class="form-group">
							...
							<label class="control-label col-md-3" style="display: none">状态</label>
						...
						<div class="form-group">
							<label class="control-label col-xs-5 col-md-3">收货单位</label>
							<div class="col-xs-7 col-md-4">
			...
			<div class="layui-card">
				<div class="layui-card-body full">
					...
					>
						...
						<div data-field="wareNm" uglcw-options="width: 140, schema:{editable: false}">产品名称</div>
...
<script>
	...
	function showBill(billId) {
		uglcw.ui.openTab('报损出库单信息', '${base}manager/showstkout?dataTp=1&billId=' + billId);
	}
