			...
			<div class="layui-card master">
				...
				<div class="layui-card-body">
					<form class="form-horizontal" uglcw-role="validator">
							...
							<div class="col-xs-4">
								<input uglcw-role="gridselector" value="${come.billNo}"
									   uglcw-options="click: function(){
											uglcw.ui.openTab('其它入库单据信息','${base}manager/showstkin?dataTp=1&billId=${come.inId}');
									   }">
							</div>
						...
						<div class="form-group">
							<label class="control-label col-xs-3">发货对象</label>
							<div class="col-xs-4">
