...
<div class="layui-fluid">
    ...
    ·                          <li onclick="add()" data-icon="add" class="k-info">新建</li>
                    ...
                    <div class="bill-info">
                        <span class="no" style="color: green;">杂费单据 ${billNo}</span>
                ...
                <div class="layui-card-body">
                    <form class="form-horizontal" uglcw-role="validator">
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label col-xs-3">付款日期</label>
                            <div class="col-xs-4">
                        ...
                        <div class="layui-col-md8">
                            <div class="layui-card">
                                <div class="layui-card-body full">
                                    ...
                                    responsive:['.master',40],
                                    url:'${base}manager/queryUseInCostItemList',
                                    criteria: '.query',
...
<script>
    ...
    function add() {
        uglcw.ui.openTab('杂费开单', '${base}manager/stkExtrasFee/add');
    }
    ...
    function draftSave() {
        ...
        uglcw.ui.loading();
        $.ajax({
            url: '${base}manager/stkExtrasFee/save',
            type: 'post',
            data: data,
            dataType: 'json',
    ...
    function audit() {
        ...
        uglcw.ui.confirm('是否确定审核？', function () {
            uglcw.ui.loading();
            $.ajax({
                url: '${base}manager/stkExtrasFee/audit',
                type: 'post',
