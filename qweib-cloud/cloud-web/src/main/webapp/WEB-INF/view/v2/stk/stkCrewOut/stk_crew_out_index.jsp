...
<div class="layui-fluid">
    ...
    ">           <ul>
                ...
                <div>
                    <iframe data-src="${base}/manager/stkCrewOut/toStkOutPageForCrewOut" width="100%" frameborder="0"
                            allowtransparency="true"></iframe>
                </div>
                <div>
                    <iframe data-src="${base}/manager/stkCrewOut/topage" width="100%" frameborder="0"
                            allowtransparency="true"></iframe>
                </div>
            </div>
        </div>
