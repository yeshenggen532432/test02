...
<div style=" text-align: center; margin:10px auto;width:794px;height:550px;border:1px solid #000000;" id="printcontent">  
    <table style="border-color: #000000;width:794px;">  
	    <tr>
		<td colspan = "6" style="font-size:18px;color:#000000;font-weight:bold;">${stkQuotePrice.proName}-客户商品报价单</td>
		</tr>
    </table>   
	...
	<thead>
		...
		<td style="font-weight:bold;border:1px solid #000000;">报价</td>
		</tr>
	</thead>
    <tbody id="chooselist">
	</tbody>
	<c:forEach items="${stkQuotePrice.list}" var="item" >
      <tr>  
