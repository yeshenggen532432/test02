                    ...
                    <ul class="uglcw-query form-horizontal query">
                        ...
                        <li style="width: 150px;">
                            <tag:select2 name="stkId" id="stkId" tableName="stk_storage" headerKey="" whereBlock="status is null or status=1"
                                         headerValue="--请选择仓库--" displayKey="id" displayValue="stk_name"/>
                        </li>
                        <li>
            ...
            <div class="layui-card">
                <div class="layui-card-body full">
                    <div id="grid" uglcw-role="grid"
                        ...
                        uglcw.ui.openTab('生产入库信息'+row.id, '${base}manager/stkProduce/show?billId='+ row.id)
                        },
                       ...
                       <%-- dblclick: function(row){
                        ...
                        url: '${base}manager/stkProduce/page',
                        criteria: '.query',
                        pageable: true
                    ">
                        <div data-field="billNo"
                             uglcw-options="width:200, template: uglcw.util.template($('#bill-no').html())">单据单号
                        </div>
                        ...
                        <div data-field="count"
                             uglcw-options="width:450, hidden: true, template: uglcw.util.template($('#product-tpl').html()) ">
                            商品信息
                        </div>
...
<script type="text/x-uglcw-template" id="toolbar">
    <a role="button" class="k-button k-button-icontext"
       href="javascript:add();">
        <span class="k-icon k-i-file-add"></span>生产入库
    </a>
</script>
...
<script>
    ...
    function showDetail(id) {
        uglcw.ui.openTab('生产入库信息' + id, '${base}manager/stkProduce/show?billId=' + id);
    }
