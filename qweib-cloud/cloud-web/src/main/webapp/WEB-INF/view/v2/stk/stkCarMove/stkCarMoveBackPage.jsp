    ...
    <div class="layui-card header">
        <div class="layui-card-body">
            <ul class="uglcw-query">
                <li>
                    <input type="hidden" uglcw-model="billType" value="2" uglcw-role="textbox">
    ...
    <div class="layui-card">
        <div class="layui-card-body full">
            <div id="grid" uglcw-role="grid"
                 uglcw-options="
                    ...
                    id:'id',
                     ...
                     dblclick:function(row){
                       uglcw.ui.openTab('车销回库单信息'+row.id, '${base}manager/stkMove/show?billId='+ row.id+$.map( function(v, k){  //只带id
                        return k+'='+(v||'');
                       }).join('&'));
                     },
                ...
                <div data-field="stkName" uglcw-options="width:130">车销仓库</div>
