            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    <div class="form-horizontal" uglcw-role="validator" novalidate id="inventory_settings">
                        <span style="font-size: 14px;color: blue; text-decoration: underline;">库存模板设置11111</span>
                        <c:forEach items="${list}" var="list" varStatus="s">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <ul uglcw-role="radio"
                                         ...
                                         uglcw-model="cljccjMdLs[${s.count-1}].isHjpms">
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <ul uglcw-role="radio"
                                         uglcw-options='"layout":"horizontal","dataSource":[{"text":"显示","value":"1"},{"text":"不显示","value":"2"}]'
                                         uglcw-model="cljccjMdLs[${s.count-1}].isDjpms" data-value="2" >
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <ul uglcw-role="radio"
                                         uglcw-options='"layout":"horizontal","dataSource":[{"text":"显示","value":"1"},{"text":"不显示","value":"2"}]'
                                         uglcw-model="cljccjMdLs[${s.count-1}].isSytwl">
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <ul uglcw-role="radio"
                                         uglcw-options='"layout":"horizontal","dataSource":[{"text":"显示","value":"1"},{"text":"不显示","value":"2"}]'
                                         uglcw-model="cljccjMdLs[${s.count-1}].isBds" value="2">
                                    </ul>
                                </div>
                            </div>
