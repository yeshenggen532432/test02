    ...
    <div class="layui-card master">
        <div class="layui-card-header btn-group">
            <ul uglcw-role="buttongroup">
                ...
                <c:if test="${permission:checkUserFieldPdm('stk.stkIn.cancel')}">
                    <li onclick="cancelClick()" id="btncancel" class="k-error" data-icon="delete" style="display: ${billId eq 0 or status eq 2?'none':''}">作废</li>
                </c:if>
            ...
            <div class="bill-info">
                <span class="no" style="color: green;"><span id="billNo" uglcw-model="billNo" style="height: 25px;"  uglcw-role="textbox" >${billNo}</span></span>
                <span class="status" style="color:red;"><span id="billStatus" style="height: 25px;width: 80px" uglcw-model="billstatus" uglcw-role="textbox">${billstatus}</span></span>
        ...
        <div class="layui-card-body">
            <form class="form-horizontal" uglcw-role="validator">
                ...
                <input uglcw-role="textbox" type="hidden" uglcw-model="inType" value="采购退货"/>
                ...
                <div class="form-group">
                    ...
                    <label class="control-label col-xs-3">退货仓库</label>
                    <div class="col-xs-7 col-xs-4">
...
<script>
    ...
    function add() {
        uglcw.ui.openTab('采购退货', '${base}manager/pcinthin?r=' + new Date().getTime());
    }
    ...
    function toPrint() {
        var billId = uglcw.ui.get("#billId").value();
        top.layui.index.openTabsPage('${base}manager/showstkinprint?billId='+billId, '采购退货'+billId+'打印');
    }
    ...
    function auditProc(billId) {
        uglcw.ui.openTab('采购退货收货' + billId, '${base}manager/showstkincheck?dataTp=1&billId=' + billId);
    }
    ...
    function showVersion(id) {
        uglcw.ui.openTab('采购退货版本记录' + id, '${base}manager/showstkinversion?billId=' + id);
    }
