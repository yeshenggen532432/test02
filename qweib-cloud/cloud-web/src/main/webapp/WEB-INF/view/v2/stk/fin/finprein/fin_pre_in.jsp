		...
		<div class="layui-col-md12">
			<div class="layui-card master">
				<div class="layui-card-header btn-group">
					...
					<div class="bill-info">
						<span class="no" style="color: green;">预收单据 ${billNo}</span>
				...
				<div class="layui-card-body">
					<form class="form-horizontal" uglcw-role="validator">
						...
						<div class="form-group" style="margin-bottom: 0px;">
							<label class="control-label col-xs-3">预收账户</label>
							<div class="col-xs-4">
							...
							>
								...
								<div data-field="amt"
									 uglcw-options="width: 100,
									  footerTemplate: '#= uglcw.util.toString(sum,\'n2\')#', format: '{0:n2}', schema:{type: 'number', validation:{min:0}}">
									金额
								</div>
				...
				<div class="layui-col-md5">
					<div class="layui-row layui-col-space5">
						<div class="layui-col-md4">
							...
							url:'${base}manager/queryIoTypeList?typeName=预收账款',
						...
						<div class="layui-col-md8">
							<div class="layui-card">
								<div class="layui-card-body full">
                                    ...
                                    responsive:['.master',40],
                                    url:'${base}manager/queryUseIoItemList?typeName=预收账款',
                                    loadFilter:function(response){
										return response.rows;
									},
                                    criteria: '.query',
...
<script>
	...
	function add() {
		uglcw.ui.openTab('预收开单', '${base}manager/toFinPreInEdit?r=' + new Date().getTime());
	}
	...
	function saveAudit() {//保存并审批
		...
		if (!form.accId) {
			return uglcw.ui.warning('请选择预收账户');
		...
		$.ajax({
			...
			success: function (json) {
				if(json.state){
					...
					{
						if(json.rows[i].itemName=='其他预收账款'){
							uglcw.ui.get('#grid').addRow({
