        ...
        <div class="layui-card-body">
            <ul class="uglcw-query form-horizontal query">
                <li>
                    ...
                    <input type="hidden" uglcw-role="textbox" uglcw-model="empId" value="${query.empId}" id="empId">
        ...
        <div class="layui-card-body full">
            <div id="grid" uglcw-role="grid"
                 uglcw-options="
                    ...
                    id:'id',
                    autoBind: true,
                    url: '${base}manager/saleManSaleStat/statItemPages',
                ...
                <div data-field="empName" uglcw-options="width:150,">业务员</div>
