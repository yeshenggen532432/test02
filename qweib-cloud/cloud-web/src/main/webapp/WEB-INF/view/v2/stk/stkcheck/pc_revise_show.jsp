	...
	<div class="layui-card">
		<div class="layui-card-body full">
			...
			<div id="grid" uglcw-role="grid"
				...
				<div data-field="stkQty" uglcw-options="width:90, editable: false">账面数量</div>
				...
				<div data-field="qty" uglcw-options="width:120, attributes:{class: 'uglcw-cell-speedy k-dirty-cell maxQtyFlag'},decimals:10, schema:{type: 'number'}">清算库存(大)
				</div>
				...
				<div data-field="minQty" uglcw-options="width:120, attributes:{class: 'k-dirty-cell minQtyFlag'},decimals:10, schema:{type: 'number'}">
					清算库存(小)
				</div>
