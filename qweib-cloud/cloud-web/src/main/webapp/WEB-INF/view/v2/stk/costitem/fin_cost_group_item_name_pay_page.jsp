            ...
            <div id="grid" uglcw-role="grid"
                 uglcw-options="{
                     ...
                     dblclick:function(row){
                       ...
                       uglcw.ui.openTab(q.itemName+'_报销单据', '${base}manager/toCostGroupPayItemsPage?'+$.map(q, function(v, k){
                        return k+'='+(v||'');
                       }).join('&'));
                     },
                      responsive:['.header',40],
                    id:'id',
                    url: 'manager/queryCostGroupItemNamePayPage',
                    criteria: '.form-horizontal',
                      aggregate:[
                ...
                <div data-field="typeName"
                     uglcw-options="width:160,footerTemplate: '合计'">费用科目
                </div>
                <div data-field="itemName" uglcw-options="width:160">费用明细科目</div>
