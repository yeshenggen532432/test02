                ...
                <div class="layui-card-body">
                    <form class="form-horizontal" uglcw-role="validator">
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3">销售单号</label>
                            <div class="col-xs-4">
                                <input uglcw-role="gridselector" readonly value="${billNo}"
                                       uglcw-options="click: function(){ showBill('${billId}'); }"
                                />
                            </div>
                            <label class="control-label col-xs-3" style="display: none">状态</label>
...
<script>
    ...
    function showBill(billId) {
        uglcw.ui.openTab('销售退货单信息', '${base}manager/showstkin?dataTp=1&billId=' + billId);
    }
    ...
    function toPrint() {
        uglcw.ui.openTab('销售单${billId}打印', '${base}manager/showstkoutprint?billId=${billId}');
    }
