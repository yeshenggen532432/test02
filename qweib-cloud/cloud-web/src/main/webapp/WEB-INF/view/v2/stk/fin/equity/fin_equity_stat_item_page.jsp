            ...
            <div id="grid" uglcw-role="grid"
                 uglcw-options="{
                    dblclick:function(row){
                       uglcw.ui.openTab(row.id+'股东权益单', '${base}manager/showFinEquityEdit?billId='+row.id+$.map( function(v, k){
                        return k+'='+(v||'');
                       }).join('&'));
                     },
                    ...
                    url: 'manager/queryEquityStatItemPage',
                    criteria: '.form-horizontal',
                            dataBound: function(){
                ...
                <div data-field="totalAmt" uglcw-options="width:120">收款金额</div>
