                ...
                <div class="layui-card-body full">
                    <div id="grid" uglcw-role="grid"
                         uglcw-options="
							...
							id:'id',
							pageable: true,
                    		url: '${base}manager/sysMemberImportMain/page',
                    		criteria: '.query',
                    		dblclick: function(row){
                                    uglcw.ui.openTab(row.title, '${base}manager/sysMemberImportMain/toSubPage?mastId='+row.id);
                            },
                    	">
...
<script>
    ...
    //下载
    function download() {
        uglcw.ui.confirm('是否下载员工模版？', function () {
