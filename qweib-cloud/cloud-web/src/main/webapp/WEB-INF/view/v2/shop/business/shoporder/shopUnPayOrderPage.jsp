    ...
    <div class="layui-card header">
        <div class="layui-card-body">
            <ul class="uglcw-query form-horizontal">
                <li>
                    <input uglcw-model="payType" uglcw-role="textbox" type="hidden" value="${param.payType}"/>
                    <input uglcw-model="status" uglcw-role="textbox" type="hidden" value="1"/>
                ...
                <li>
                    <input uglcw-model="sdate" uglcw-role="datepicker" value="${not empty param.from ? param.sdate : sdate}">
                </li>
                <li>
        ...
        <div class="layui-card-body full">
            <div id="grid" uglcw-role="grid"
                 uglcw-options="
                    ...
                    id:'id',
                    checkbox: true,
                    url: '${base}manager/shopBforder/unPayOrderPage',
                    criteria: '.form-horizontal',
                    pageable: true
                    ">
                <jsp:include page="/WEB-INF/view/v2/include/order_detail_include.jsp">
                    <jsp:param name="hidePayInfo" value="true"/>
                </jsp:include>
            </div>
        </div>
    </div>
