		...
		<script type="text/javascript">
			...
			function querydata(){			
				...
				$("#datagrid").datagrid('load',{
					url:"manager/queryPayUnitStat?database="+database,					
					sdate:$("#sdate").val(),
					edate:$("#edate").val(),
					ioType:$("#ioType").val(),
					amtType:$("#amtType").val()
		    ...
		    //alert(rowData.inQty);
				...
				parent.closeWin('供应商付款明细');
		    	parent.add('供应商付款明细','manager/toPayUnitDetail?sdate=' + sdate + '&edate=' + edate + '&ioType=' + outType + '&unitId=' + rowData.unitId + '&amtType=' + amtType);
