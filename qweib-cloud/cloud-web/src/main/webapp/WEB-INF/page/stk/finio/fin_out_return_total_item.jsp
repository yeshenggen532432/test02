		...
		<script type="text/javascript">
			...
			function queryorder(){
				$("#datagrid").datagrid('load',{
					url:"manager/queryFinOutPageTotalItem?database="+database,
					jz:"1",
					billNo:$("#orderNo").val(),
					proName:$("#proName").val(),
					sdate:$("#sdate").val(),
			...
			function onDblClickRow(rowIndex, rowData)
		    {
				...
				parent.closeWin('往来借出单据' + rowData.id);
		    	parent.add('往来借出单据' + rowData.id,'manager/showFinOutEdit?billId=' + rowData.id);
		    }
