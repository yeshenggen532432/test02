...
<html>
	...
	<body onload="displaySub()">
		...
		<table id="datagrid" class="easyui-datagrid" fit="true" singleSelect="true"
			...
			<thead>
				<tr>
					...
					<th  data-options="field:'qty',width:80,align:'center'" formatter="amtformatter"> 
						大单位数量
					</th>
					...
					<th field="minQty" width="80" align="center"  formatter="amtformatter">
						小单位数量
					</th>
					<th field="sunitPrice" width="60" align="center">
						小单位价格
					</th>
		...
		<div id="tb" style="padding:5px;height:auto">
		 初始化时间: ${checkTime}&nbsp;&nbsp;初始化仓库: ${stkName} &nbsp;&nbsp;盘点人: ${staff}&nbsp;&nbsp;单据状态:
