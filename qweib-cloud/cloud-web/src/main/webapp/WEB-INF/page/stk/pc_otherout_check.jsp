...
var basePath = '<%=basePath %>';
					...
					<div class="pcl_lfbox1">
						<table id="more_list">
							...
							<tbody id="chooselist">
								...
								<td><input name="edtoutqty1" type="text" class="pcl_i2" value="${item.outQty1}"  style="color:red"/></td>
	...
	<script type="text/javascript">
		...
		function auditProc()
		{
			...
			for (var i=0;i<trList.length;i++) {
			    ...
			    var outQty = tdArr.eq(8).find("input").val();
			   //alert(outQty);
		        		...
		        		for(var i = 0;i < size; i++)
		        			{
		        				...
		        				if(i == 0)
		    					{
		    						...
		    						$("#driverspan").text(json.list[i].driverName);
	...
	*/
	function showBill(billId){
		parent.closeWin('其它出库发票信息' + billId);
    	parent.add('其它出库发票信息' + billId,'manager/showstkout?dataTp=1&billId=' + billId);
	}
