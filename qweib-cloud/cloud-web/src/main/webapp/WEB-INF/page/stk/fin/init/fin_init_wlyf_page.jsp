...
<script type="text/javascript">
	$('#easyTabs').tabs({
		...
		onSelect:function(title){
			if(title=="供应商应付初始化"){
				document.getElementById("wljkfrm0").src='${base}manager/finInitWlYwMain/toProPayInit?proType=0&bizType=CSHYF';
			}else if(title=="客户应付账初始化"){
				document.getElementById("wljkfrm1").src='${base}manager/finInitWlYwMain/toProPayInit?proType=2&bizType=CSHKHYF';
			}else if(title=="员工应付账初始化"){
				document.getElementById("wljkfrm2").src='${base}manager/finInitWlYwMain/toProPayInit?proType=1&bizType=CSHYGYF';
			}
		}});
</script>
</html>
