...
<html>
	...
	<table width="100%" height="100%" border="0" cellpadding="0"
	 ...
	 <td valign="top" align="left">
			<iframe src="manager/toQueryWarePage?isType=0&stkId=${stkId}" name="warefrm" id="warefrm" frameborder="0" marginheight="0" marginwidth="0" width="100%" height="100%"></iframe>
	</td>
	</tr>
	</table>	
		<script type="text/javascript">
			...
			function toShowWare(id,isType){
				document.getElementById("warefrm").src="${base}/manager/toQueryWarePage?isType=${isType}&stkId=${stkId}&waretype="+id;
			}
		</script>
	</body>
</html>
