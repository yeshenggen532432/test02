...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<table id="datagrid" class="easyui-datagrid" fit="true" singleSelect="false"
			url="manager/queryVehiclePage" title="" iconCls="icon-save" border="false"
			...
			<thead>
				<tr>
					...
					<th field="vehNo" width="80" align="center">
						车牌号
					</th>
					<th field="vehType" width="120" align="center">
						车型
					</th>				
		...
		<div id="tb" style="padding:5px;height:auto">
		     姓名: <input name="vehNo" id="vehNo" style="width:100px;height: 20px;" onkeydown="toQuery(event);"/>
		...
		<script type="text/javascript"><!--
			...
			function querydriver(){
				...
				$("#datagrid").datagrid('load',{
					url:"manager/queryVehiclePage?dataType=1&vehNo="+$("#vehNo").val()
			...
			function toadddriver(){
				location.href="${base}/manager/toVehicleEdit";
			}
			//修改
			function getSelected(){
				...
				if (row){
					  ...
					  location.href="${base}/manager/toVehicleEdit?Id="+row.id;
				 }else{
					alert("请选择要修改的行！");
				}
			}
		   ...
		   function updateIsTy(_this,id,isTy){
			   alert(id);
				$.ajax({
					url:"manager/updateVehicleStatus",
					type:"post",
