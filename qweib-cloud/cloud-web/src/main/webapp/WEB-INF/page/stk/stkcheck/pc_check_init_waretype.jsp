...
<html>
	...
	<input type="hidden" id="billId" value="${billId}" /> 
		...
		<div id="wareTypeDiv" data-options="region:'center'">
			<iframe src="manager/showcheckinit?billId=${billId}" name="warefrm" id="warefrm" frameborder="0" marginheight="0" marginwidth="0" width="100%" height="100%"></iframe>
		</div>
		<script type="text/javascript">
			//点击商品分类树查询
			function toShowWare(id){
				//document.getElementById("warefrm").testwaretype(id);
				window.frames['warefrm'].chooseWareType(id);
			}
		</script>
	</body>
</html>
