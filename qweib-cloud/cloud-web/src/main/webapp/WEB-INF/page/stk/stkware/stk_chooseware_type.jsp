	...
	<table width="100%" height="100%" border="0" cellpadding="0"
			...
			<tr valign="top" align="left">
				<td align="left"  id="wd" style="width: 170;" height="100%" >
				 ...
				 <td valign="top" align="left">
					<iframe src="manager/toStkChooseWare" name="warefrm" id="warefrm" frameborder="0" marginheight="0" marginwidth="0" width="100%" height="100%"></iframe>
	 			 </td>
			</tr>
		</table>
		<script type="text/javascript">
			...
			function toShowWare(id){
				...
				document.getElementById("warefrm").src="${base}/manager/toStkChooseWare?wtype="+id;
			}
		</script>
	</body>
</html>
