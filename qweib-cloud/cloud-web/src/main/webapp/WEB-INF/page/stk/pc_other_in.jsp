...
<html style="font-size: 50px;">
	...
	<head>
		...
		<script src="<%=basePath %>/resource/stkstyle/js/pcotherin.js" type="text/javascript" charset="utf-8"></script>
			...
			<div class="pcl_lib_out">
				...
				<div class="pcl_fm">
					<table>
						<tbody>
							<tr>
								<td style="text-align: center;">发货单位：</td>
								<td>
						...
						<table id="more_list">
							<thead>
								<tr>
									...
									<td style="display: ${permission:checkUserFieldDisplay('stk.stkIn.lookamt')}">入库金额</td>
									<td>生产日期</td>
