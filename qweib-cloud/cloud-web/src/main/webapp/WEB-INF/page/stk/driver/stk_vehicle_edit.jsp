...
<html>
	...
	<body>
		...
		<div class="box">
  			<form action="manager/saveVehicle" name="stkfrm" id="stkfrm" method="post">
  			<input  type="hidden" name="id" id="id" value="${driver.id}"/>    
  				
  				
  			    <dl id="dl">
	      			<dt class="f14 b">车辆信息</dt>
	      			
	        		<dd>
	      				<span class="title">车牌号：</span>
	        			<input class="reg_input" name=vehNo id="vehNo" value="${veh.vehNo}" style="width: 120px"/>
	        			<span id="memberNmTip" class="onshow"></span>
	        		</dd>
	        		<dd>
	      				<span class="title">车型：</span>
	        			<input class="reg_input" name="vehType" id="vehType" value="${veh.vehType}" style="width: 120px"/>
		...
		<script type="text/javascript">
		    ...
		    $(function(){
				...
				$("#vehNo").formValidator({onShow:"请输入(15个字符以内)",onFocus:"请输入(15个字以内)",onCorrect:"通过"}).inputValidator({min:1,max:15,onError:"请输入(15个字符以内)"});
			});
			...
			function toback(){
				location.href="${base}/manager/toStkVehicle";
			}
