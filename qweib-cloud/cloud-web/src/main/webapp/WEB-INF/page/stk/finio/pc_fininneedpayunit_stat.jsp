		...
		<script type="text/javascript">
		    ...
		    initGrid();		   
			   ...
			   function initGrid()
			   {
				   ...
				   var col = {
					...
					$('#datagrid').datagrid({
						url:'manager/queryFinInNeedPayUnitStat',
						queryParams:{
							sdate:$("#sdate").val(),
							edate:$("#edate").val()
			...
			function querydata(){			
				...
				$("#datagrid").datagrid('load',{
					url:"manager/queryFinInNeedPayUnitStat?database="+database,					
					sdate:$("#sdate").val(),
					edate:$("#edate").val()
		    ...
		    //alert(rowData.inQty);
		    	...
		    	parent.add('供应商应付款明细','manager/toFinInUnitNeedPayDetail?sdate=' + sdate + '&edate=' + edate  + '&unitId=' + rowData.unitId );
