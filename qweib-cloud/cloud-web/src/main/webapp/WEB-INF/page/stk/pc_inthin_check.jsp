	...
	<body>
		...
		<div class="center">
			...
			<div class="pcl_lib_out">
				<p class="pcl_title">采购退货出库单-${billNo}</p>
					...
					<div class="pcl_lfbox1">
						<table id="more_list">
							...
							<tbody id="chooselist">
								...
								<td><input name="edtqty" type="text" class="pcl_i2" value="${item.qty*(-1)}" /></td>
								<td><input name="edtinQty" type="text" class="pcl_i2" value="${item.inQty*(-1)}" /></td>
								<td><input name="edtinQty1" type="text" class="pcl_i2" value="${item.inQty1*(-1)}" onchange="countAmt()" style="color:red"/></td>
