...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="initGrid()">
		...
		<a class="easyui-linkbutton" iconCls="icon-add" plain="true" href="javascript:newBill();">收款开单</a>
		...
		<div>
			...
			转移日期: <input name="sdate" id="sdate"  onClick="WdatePicker();" style="width: 100px;" value="${sdate}" readonly="readonly"/>
		   ...
		   //$("#billStatus").val("未收货");
			...
			function queryorder(){
				$("#datagrid").datagrid('load',{
					url:"manager/queryFinTransPage?database="+database,
					jz:"1",
					billNo:$("#orderNo").val(),
		    ...
		    function newBill()
			{
		    	...
		    	parent.closeWin('内部转移开单');
				parent.add('内部转移开单','manager/toFinTransEdit');
		    	//window.location.href='${base}/manager/toFinTransEdit';
			}
		    ...
		    {
				parent.closeWin('内部转移单');
		    	parent.add('内部转移单' ,'manager/showFinTransEdit?billId=' + rowData.id);
