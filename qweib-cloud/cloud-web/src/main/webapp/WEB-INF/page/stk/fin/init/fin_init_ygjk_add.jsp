...
<html style="font-size: 50px;">
	...
	<body>
		...
		<form action="<%=basePath %>/manager/finInitQtWlMain/save" name="savefrm" id="savefrm" method="post">
		<div class="center">
					...
					<div class="pcl_lfbox1">
						<table id="more_list">
							<thead>
								<tr>
									<td width="15%">
										<c:if test="${bizType eq 'CSHGYSJK'}">
											往来供应商
										</c:if>
										<c:if test="${bizType eq 'CSHKHJK'}">
											往来客户
										</c:if>
										<c:if test="${bizType eq 'CSHYGJK'}">
											员工名称
										</c:if>
									</td>
									<td  width="20%">初始化借款金额</td>
