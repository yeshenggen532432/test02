...
<html>
				...
				<table width="100%">
					<thead>
						...
						<tr >							
							...
							<td align="center" style="font-size: 11px" id="totalFhQty"></td>
	...
	function queryData(){
			...
			var path = "<%=basePath %>/web/stockWebRpt/wareOutStat";
			...
			$.ajax({
		        url: path,
		        type: "POST",
		        data : {"token":token,"waretype":waretype,"wareNm":wareNm,"sdate":startDate,"stkId":0,"edate":endDate,"page":pageIndex,"rows":20},
		        dataType: 'json',
		        async : false,
		        success: function (json) {
		        	if(json.state){
		        		...
		        		if(size>0){
        					...
        					$("#totalFhQty").html(amtformatter(json.rows[i].sumQty));
