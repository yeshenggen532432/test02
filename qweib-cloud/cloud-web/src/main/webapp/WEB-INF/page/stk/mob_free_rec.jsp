	...
	<header class="fixed_top">
		...
		<div class="order_count">
			<ul>
				...
				<li>
					已付款 &nbsp;&nbsp;<a style="color:red;width:60px">${recAmt}</a>&nbsp;&nbsp; 还需收&nbsp;&nbsp;<a style="color:red;width:60px">${needRec}</a>
					
				</li>
				<li>
					 核销金额
					<div class="order_mes fr">
						<span><input type="text" placeholder="请点击输入" id="cashpay" style="text-align:right" value ="${needRec}"/></span>
					</div>
				</li>
