...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div style="margin-bottom:5px">
			<tag:permission name="销售开单" image="icon-add" onclick="javascript:newOut(0);"   buttonCode="stk.stkOut.createxs"></tag:permission>
			...
			--%> 
			<a class="easyui-linkbutton" iconCls="icon-search" plain="true" href="javascript:hisBill();">历史发票</a>
		...
		<div>
			...
			仓库：<tag:select name="stkId" id="stkId" tableName="stk_storage" headerKey=""
						   whereBlock="status=1 or status is null"
						   headerValue="--请选择--" displayKey="id" displayValue="stk_name"/>
			 是否车销:
		     <select name="saleCar" id="saleCar" onchange="queryorder()">
	        ...
	        备注: <input name="remo" id="remo" style="width:80px;height: 20px;" onkeydown="toQuery(event);"/>      
		...
		<script type="text/javascript">
		    ...
		    function hisBill()
			{
				parent.add('历史发票','manager/queryStkOutHis');
			}
