...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body >
		...
		<div id="tb" style="padding:5px;height:auto">
			<div>
			<a class="easyui-linkbutton" iconCls="icon-add" plain="true" href="javascript:newBill('SCRK');">生产入库</a>
		...
		<div>
	       ...
	       仓库：<tag:select name="stkId" id="stkId" tableName="stk_storage" headerKey="" headerValue="--请选择--" displayKey="id" whereBlock="status is null or status=1" displayValue="stk_name"/>
		...
		initGrid();
			...
			function newBill(bizType)
			{
				...
				parent.add(billName,'manager/stkProduce/add?bizType='+bizType);
			}
		    ...
		    function onDblClickRow(rowIndex, rowData)
		    {
		    	...
		    	parent.add(billName + rowData.id,'manager/stkProduce/show?billId=' + rowData.id);
		    }
		    ...
		    function showBill(){
				...
				if (row){
			    	...
			    	parent.add(billName + row.id,'manager/stkProduce/show?billId=' + row.id);
				}else{
					alert("请选择行");
				}
		    }
