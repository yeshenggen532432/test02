...
<script type="text/javascript">
	$('#easyTabs').tabs({
		...
		onSelect:function(title){
			if(title=="供应商应收初始化"){
				document.getElementById("wljkfrm0").src='${base}manager/finInitWlYwMain/toRecInit?proType=0&bizType=CSHGYSYS';
			}else if(title=="客户应收账初始化"){
				document.getElementById("wljkfrm1").src='${base}manager/finInitWlYwMain/toRecInit?proType=2&bizType=CSHYS';
			}else if(title=="员工应收账初始化"){
				document.getElementById("wljkfrm2").src='${base}manager/finInitWlYwMain/toRecInit?proType=1&bizType=CSHYGYS';
			}
		}});
</script>
</html>
