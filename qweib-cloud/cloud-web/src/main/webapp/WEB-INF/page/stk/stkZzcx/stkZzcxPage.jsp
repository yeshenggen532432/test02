...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body >
		...
		<div id="tb" style="padding:5px;height:auto">
			<div>
			<a class="easyui-linkbutton" iconCls="icon-add" plain="true" href="javascript:newBill('ZZRK');">组装开单</a>
			<a class="easyui-linkbutton" iconCls="icon-add" plain="true" href="javascript:newBill('CXCK');">拆卸开单</a>
		...
		<div>
		   ...
		   日&nbsp;&nbsp;期: <input name="sdate" id="sdate"  onClick="WdatePicker();" style="width: 80px;" value="${sdate}" readonly="readonly"/>
	        ...
	        单据类型: <select name="bizType" id="bizType">
		...
		initGrid();
			...
			function newBill(bizType)
			{
				...
				parent.add(billName,'manager/stkZzcx/add?bizType='+bizType);
			}
		    ...
		    function onDblClickRow(rowIndex, rowData)
		    {
		    	...
		    	parent.add(billName + rowData.id,'manager/stkZzcx/show?billId=' + rowData.id);
		    }
		    ...
		    function showBill(){
				...
				if (row){
			    	...
			    	parent.add(billName + row.id,'manager/stkZzcx/show?billId=' + row.id);
				}else{
					alert("请选择行");
				}
		    }
