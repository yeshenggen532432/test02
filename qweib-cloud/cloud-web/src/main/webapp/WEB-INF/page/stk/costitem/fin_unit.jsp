...
<html>
	...
	<body>
		...
		<div class="box">
  			<form action="manager/savefinunit" name="stkfrm" id="stkfrm" method="post">
  			<input  type="hidden" name="id" id="id" value="${pro.id}"/>    
  				
  				
  			    <dl id="dl">
	      			<dt class="f14 b">往来单位信息</dt>
	      			<dd>
	      				<span class="title">单位编码：</span>
		...
		<script type="text/javascript">
			...
			function toback(){
				location.href="${base}/manager/toFinUnitPage";
			}
