...
<html style="font-size: 50px;">
	...
	<head>
		...
		<script src="<%=basePath %>/resource/stkstyle/js/pccollarout.js" type="text/javascript" charset="utf-8"></script>
						...
						<table id="more_list">
							<thead>
								<tr>
									...
									<td>产品规格</td>
									<td>单位</td>
									<td style="display: ${permission:checkUserFieldDisplay('stk.stkOut.lookqty')}">领用数量</td>
									<td style="display:none">单价</td>
									<td style="display: none">报损金额</td>
									<td>生产日期</td>
									<td>有效期</td>
									<td>备注</td>
							...
							<c:forEach items="${warelist}" var="item" varStatus="s">
								<tr>
									...
									<td style="display: none">${item.amt}</td>
