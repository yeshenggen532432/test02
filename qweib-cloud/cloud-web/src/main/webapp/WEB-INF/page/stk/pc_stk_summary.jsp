...
<div id="wareTypeDiv" data-options="region:'center'">
    ...
    <div id="tb" style="padding:5px;height:auto">
        时间: <input name="sdate" id="sdate" onClick="WdatePicker();" style="width: 100px;" value="${sdate}"
                   readonly="readonly"/>
        <img onclick="WdatePicker({el:'stime'})" src="resource/skin/datePicker.gif" width="16" height="22"
             align="absmiddle" style="cursor: pointer;"/>
        -
        <input name="edate" id="edate" onClick="WdatePicker();" style="width: 100px;" value="${edate}"
               readonly="readonly"/>
        <img onclick="WdatePicker({el:'etime'})" src="resource/skin/datePicker.gif" width="16" height="22"
             align="absmiddle" style="cursor: pointer;"/>
        ...
        <a class="easyui-linkbutton" iconCls="icon-save" href="javascript:sumStkProc();">重新计算库存</a>
        <span style="display: ${permission:checkUserFieldDisplay('stk.wareSfcStat.showamt')}">
			...
			过滤数量为0的记录否：<input type="checkbox" id="hideZero" onchange="querydata()" checked="checked"/>
			</span>
...
<script type="text/javascript">
    ...
    function initGrid() {
        ...
        var col = {
            ...
            align: 'center',
            formatter: amtformatter,
            hidden: checkIsShow('其它销售成本') || isExpand
        ...
        var col = {
            ...
            align: 'center',
            formatter: amtformatter,
            hidden: checkIsShow('终端零售成本') || isExpand
