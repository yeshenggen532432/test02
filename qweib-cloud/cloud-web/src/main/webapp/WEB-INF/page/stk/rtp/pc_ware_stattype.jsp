...
<html>
	...
	<body class="easyui-layout">
		...
		<div id="wareTypeDiv" data-options="region:'center'" title="商品信息">
			<iframe src="manager/toWareStat?isType=0" name="warefrm" id="warefrm" frameborder="0" marginheight="0" marginwidth="0" width="100%" height="100%"></iframe>
		</div>
		<script type="text/javascript">
			//点击商品分类树查询
			function toShowWare(id,isType){
				//document.frames['warefrm'].document.getElementById('wtype').value=id;
				//document.getElementById("warefrm").src="${base}/manager/toWareStat?wtype="+id;
				//document.getElementById("warefrm").document.getElementById("wtype").value=id;
				//document.getElementById("warefrm").queryData();
				window.frames['warefrm'].document.getElementById('wtype').value=id;
				window.frames['warefrm'].document.getElementById('isType').value=isType;
				window.frames['warefrm'].queryData();
			}
		</script>
	</body>
</html>
