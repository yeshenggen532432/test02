...
<html style="font-size: 50px;">
	...
	<head>
		...
		<script src="<%=basePath %>/resource/stkstyle/js/fin_cost.js" type="text/javascript" charset="utf-8"></script>
	...
	<body>
		...
		<div class="center">
			...
			<div class="pcl_lib_out">
				<p class="pcl_title">报销单据-${billNo}</p>
						...
						<tbody>
							<tr>
								...
								<div class="pcl_input_box pcl_w2">
									<input name="text" id="inDate"  onClick="WdatePicker({skin:'whyGreen',dateFmt: 'yyyy-MM-dd HH:mm'});" style="width: 100px;" value="${costTimeStr}"  readonly="readonly"/>
								</div>
								</td>
								<td>合计金额：</td>
			...
			<div class="cp_list2">
				...
				<div class="pcl_box_left">
					...
					<div class="cp_btn_box">
						<a href="javascript:;" class="on">供应商</a><a href="javascript:;">部门</a><a href="javascript:;">客户</a><a href="javascript:;">其它</a>
					</div>
				</div>
				<div class="pcl_3box">
