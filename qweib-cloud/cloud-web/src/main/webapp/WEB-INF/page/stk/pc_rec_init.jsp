		...
		<script type="text/javascript">
			...
			function toSubmit(){
					...
					$.messager.confirm('确认', '是否确定保存?',function(r){
						if(r){
							var path = "manager/finInitWlYwMain/recInit";
							$.ajax({
						        url: path,
						        type: "POST",
			...
			function selectFinPreIn(){
				...
				var url = "manager/toSelectFinPreInPage?proName=${cstName}&proType=${proType}";
				var title = "选择预收款单";
				if($("#yfkChk").is(":checked")==true){
					url = "manager/dialogPayPage?proName=${cstName}&proType=${proType}";
					title = "选择应付款单";
				}
