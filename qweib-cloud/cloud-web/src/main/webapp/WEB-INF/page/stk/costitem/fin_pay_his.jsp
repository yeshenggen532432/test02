...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="initGrid()">
		...
		<div>
		     ...
		     原单号: <input name="costNo" id="costNo" style="width:120px;height: 20px;" onkeydown="toQuery(event);"/>
			付款对象: <input name="proName" id="proName" style="width:120px;height: 20px;" onkeydown="toQuery(event);"  value="${proName}"/>
			明细科目名称:  <input name="itemName" id="itemName" style="width:100px;height: 20px;" value="${itemName}"/>
		...
		<script type="text/javascript">
		   ...
		   //$("#billStatus").val("未收货");
		    ...
		    {
				parent.parent.closeWin('费用支付凭证');
				parent.parent.add('费用支付凭证','manager/showFinPayEdit?billId=' + rowData.id);
