...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div style="margin-bottom:5px">   
		 <tag:permission name="生产入库" image="icon-add" onclick="javascript:newProduceBill();"   buttonCode="stk.stkIn.createkg"></tag:permission> 
		...
		<div>
			...
			供应商: <input name="proName" id="proName" style="width:120px;height: 20px;" onkeydown="toQuery(event);"/>
		   ...
		   $("#billStatus").val("暂存");
			...
			function queryorder(){
				$("#datagrid").datagrid('load',{
					url:"manager/stkInPage?database="+database,
					jz:"1",
					billNo:$("#orderNo").val(),
					proName:$("#proName").val(),
					memberNm:$("#memberNm").val(),
