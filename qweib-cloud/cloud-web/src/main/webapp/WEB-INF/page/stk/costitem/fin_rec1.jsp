...
<html style="font-size: 50px;">
	...
	<head>
		...
		<script src="<%=basePath %>/resource/stkstyle/js/fin_rec.js" type="text/javascript" charset="utf-8"></script>
...
var basePath = '<%=basePath %>';
	...
	<body>
		...
		<div class="center">
			...
			<div class="pcl_lib_out">
				<p class="pcl_title">其它收入凭证-${billNo}</p>
					...
					<table>
						<tbody>
							...
							<div class="selbox" id="stklist">
								...
								<td colspan="3">
									<div class="pcl_txr">
										<textarea name="" id="remarks" >${remarks1}</textarea>
									</div>
								</td>
							</tr>
	...
	<script type="text/javascript">
		...
		function loadData()
		{
			var path = "<%=basePath %>/manager/queryIncomeItemList";
			$.ajax({
				url: path,
				type: "POST",
				data : {"typeName":'营业外收入',"itemName":'其它营业外收入'},
				dataType: 'json',
				async : false,
