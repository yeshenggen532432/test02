	...
	<body onload="initGrid()">
		...
		时间: <input  name="sdate" id="sdate"  onClick="WdatePicker();" style="width: 100px;" value="${sdate}" readonly="readonly"/>
			 ...
			 产品名称: <input name="wareNm" id="wareNm" style="width:120px;height: 20px;" onkeydown="toQuery(event);"/>
			  ...
			  <a class="easyui-linkbutton" iconCls="icon-download" href="javascript:toDownloadDataExcel();">下载发票明细</a>
		</div>
		<div>
	  	</div>
		...
		<script type="text/javascript">
			...
			function querydata(){
			  ...
			  function toDownloadDataExcel() {
				  ...
				  var  khNm=$("#khNm").val();
                  if(confirm("是否下载数据?")){
					window.location.href="manager/downloadOutWareListForBillToExcel?sdate="+sdate+"&edate="+edate+"&wareNm="+wareNm+"&khNm="+khNm+"&subIds="+ids+"";
				}
