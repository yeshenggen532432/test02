	...
	<body onload="initGrid()">
		...
		<script type="text/javascript">
		 ...
		 function onDblClickRow(rowIndex, rowData)
		 {
			 ...
			 parent.closeWin('二批返利计算明细');
			 parent.add('二批返利计算明细','manager/toStkOutEpRebateDetail?sdate=' + sdate + '&edate=' + edate +'&cstId='+cstId+'&outType=' + outType + '&wareId=' + wareId);
		 }
			...
			function createRptData()
		    {
		    	...
		    	parent.add('生成客户费用统计表','manager/toStkOutEpRebateSave?sdate=' + sdate + '&edate=' + edate +'&outType='+outType+'&khNm=' + stkUnit+'&customerType='+customerType + '&timeType=' + dateType + '&wareNm=' + wareNm);
		    }
			
			function queryRpt()
		    {
		    	parent.closeWin('生成的统计表');
		    	parent.add('生成的统计表','manager/toStkCstStatQuery?rptType=9');
		    }
