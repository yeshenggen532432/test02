...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="initGrid()">
		...
		<a class="easyui-linkbutton" iconCls="icon-add" plain="true" href="javascript:newBill();">往来借入开单</a>
		<a class="easyui-linkbutton" iconCls="icon-search" href="javascript:showPayStat();">借入统计</a>
		<%--
		<a class="easyui-linkbutton" iconCls="icon-search" href="javascript:showNeedPayStat();">应还款统计</a>		
		--%>	
		</div>	
		<div>
			...
			&nbsp;
			<span style="background-color:#FF00FF;border: 1;color:white ">&nbsp;被冲红单&nbsp;</span>&nbsp;<span style="background-color:red;border: 1;color:white">
			&nbsp;&nbsp;&nbsp;冲红单&nbsp;&nbsp;&nbsp;</span>&nbsp;<span style="background-color:blue;border: 1;color:white">&nbsp;&nbsp;&nbsp;作废单&nbsp;&nbsp;&nbsp;</span>
		...
		<script type="text/javascript">
		   ...
		   //$("#billStatus").val("未收货");
		    ...
		    function newBill()
			{
		    	...
		    	parent.closeWin('往来借入开单');
				parent.add('往来借入开单','manager/toFinInEdit');
			}
		    ...
		    {
		    	parent.closeWin('借入统计');
		    	parent.add('借入统计','manager/toFinInStat?dataTp=1');
		    }

		    function showNeedPayStat()
		    {
		    	parent.closeWin('往来应还统计');
		    	parent.add('往来应还统计','manager/toFinInNeedPayStat?dataTp=1');
			}
