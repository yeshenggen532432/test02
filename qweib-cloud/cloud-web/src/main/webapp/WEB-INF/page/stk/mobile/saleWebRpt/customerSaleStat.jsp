...
<html>
	...
	<body class="bg1">
		...
		<div class="src_box">
			<div class="src">
				...
				<input id="customerName" type="text"   placeholder="客户名称" />
			</div>
		</div>
		...
		<div class="sctb1" touchmove="queryData()">
			<div class="sctbw">
				<table >
					<thead>
						<tr >							
							<td align="center" style="font-size: 11px">客户名称</td>
	...
	function queryData(){
			...
			var path = "<%=basePath %>/web/saleWebRpt/customerSaleStat";
			var token = $("#tmptoken").val();
			var khNm = $("#customerName").val();
			$.ajax({
		        url: path,
		        type: "POST",
