...
<html>
	...
	<body class="bg1">
		...
		<input  type="hidden" name="token" id="tmptoken" value="${token}"/>
			<table>
				<tr>
					...
					<td width="25%">
						<div class="dtbox">
							<a href="javascript:;" id = "choosestatus">未发货</a>
							<img src="<%=basePath %>/resource/stkstyle/img/icon22.png"/>
						</div>
					</td>
					<td width="25%">
		...
		<div class="bottom_bb">
			<div class="w">
				<p>发票总数：<i id = "totalqty">0</i> <span class="fr">总金额：<i id="totalamt">0元</i></span></p>
			</div>
			<div class="bt">
				<table>
					<tr>
						<td><a href="javascript:showCheck();">发货</a></td>
						<td><a href="javascript:showOutList();">发货明细</a></td>
	...
	<script src="<%=basePath %>/resource/stkstyle/js/stkoutquery.js" type="text/javascript" charset="utf-8"></script>
	...
	<script type="text/javascript">
		...
		function showCheck()
		{
		    ...
		    var token = $("#tmptoken").val();
		    window.location.href='stkoutCheck?token=' + token +'&billId=' + operateBoxs[0] + '&opeType=0';
		...
		function showOutList()
	    {
		    ...
		    window.location.href='toOutList?token=' + token + '&billId=' + operateBoxs[0];
	    }
