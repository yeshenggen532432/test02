...
<script type="text/javascript">  
    ...
    function changeTemplate(o){
		...
		location = 'manager/showstkoutbatchprint?dataTp=1&billIds=${billIds}&printType=1&fromFlag=${param.fromFlag}&templateId='+o.value+"&merge="+mergeId;
	}
	
    function changeMerge(o){
		var  templateId =$("#templateId").val();
		location = 'manager/showstkoutbatchprint?dataTp=1&billIds=${billIds}&printType=1&fromFlag=${param.fromFlag}&templateId='+templateId+"&merge="+o.value;
	}
  $("#mergeId").val('${merge}');
