		...
		<script type="text/javascript">
			...
			function querydata(){			
				...
				$("#datagrid").datagrid('load',{
					url:"manager/queryFinOutUnitStat?database="+database,					
					sdate:$("#sdate").val(),
					edate:$("#edate").val(),
					amtType:$("#amtType").val()
				});
		    ...
		    //alert(rowData.inQty);
		    	...
		    	parent.add('供应商付款明细','manager/toFinOutUnitDetail?sdate=' + sdate + '&edate=' + edate  + '&unitId=' + rowData.unitId + '&amtType=' + amtType);
