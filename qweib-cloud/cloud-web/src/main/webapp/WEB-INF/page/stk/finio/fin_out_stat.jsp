...
<div id="tb" style="padding:5px;height:auto">
    ...
    付款日期: <input name="sdate" id="sdate" onClick="WdatePicker();" style="width: 100px;" value="${sdate}"
                 readonly="readonly"/>
...
<script type="text/javascript">
    ...
    function queryorder(type) {
        ...
        if (type == 0) {
            $("#datagrid").datagrid('load', {
                url: "manager/queryFinOutStat?database=" + database,
                sdate: $("#sdate").val(),
                edate: $("#edate").val()
    ...
    function onClickCell(index, field, value) {
        ...
        if (amtType != "") {
            ...
            parent.add('往来单位借款统计', 'manager/toFinOutUnitStat?sdate=' + sdate + '&edate=' + edate + '&amtType=' + amtType);
        }
