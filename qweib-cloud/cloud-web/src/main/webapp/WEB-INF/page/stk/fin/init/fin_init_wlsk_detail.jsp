...
<div id="tb" style="padding:5px;height:auto">
    ...
    <div>
        ...
        单据日期: <input name="sdate" id="sdate" onClick="WdatePicker();" style="width: 100px;" value="${sdate}"
                     readonly="readonly"/>
        <img onclick="WdatePicker({el:'sdate'})" src="resource/skin/datePicker.gif" width="16" height="22"
             align="absmiddle" style="cursor: pointer;"/>
        -
        <input name="edate" id="edate" onClick="WdatePicker();" style="width: 100px;" value="<%= today%>"
               readonly="readonly"/>
        ...
        <a class="easyui-linkbutton" iconCls="icon-redo" href="javascript:toCustomerModel();">下载模版</a>
        <a class="easyui-linkbutton" iconCls="icon-edit" href="javascript:toUpCustomer();">上传数据</a>
...
<div id="upDiv" class="easyui-window" style="width:500px;height:100px;padding:10px;"
    ...
    <form action="manager/finInitWlYwMain/toUpCustomerInitAmt?bizType=${bizType}" id="upFrm" method="post" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    function toCustomerModel() {
        if (confirm("是否下载模版?")) {
            window.location.href = "manager/finInitWlYwMain/toCustomerInitAmtTemplate";
        }
    }
    ...
    function toAdd() {
        var bizType = '${bizType}';
        var proType = 1;
        var title = '员工应收账初始化录入';
        if (bizType == 'CSHGYSYS') {
            title = '供应商应收初始化录入';
            proType = 0;
        } else if (bizType == 'CSHYS') {
            title = '客户应收账初始化录入';
            proType = 2;
        } else {
            title = '员工应收账初始化录入';
        ...
        window.top.add(title, '${base}manager/finInitWlYwMain/add?bizType=' + bizType + '&proType=' + proType + '&ioMark=1&_sticky=v2');
    }
