		...
		<script type="text/javascript">
			...
			function querydata(){			
				...
				$("#datagrid").datagrid('load',{
					url:"manager/queryRecUnitStat?database="+database,					
					sdate:$("#sdate").val(),
					edate:$("#edate").val(),
					ioType:$("#ioType").val(),
					amtType:$("#amtType").val()
		    ...
		    //alert(rowData.inQty);
				...
				parent.closeWin('客户收款明细');
		    	parent.add('客户收款明细','manager/toRecUnitDetail?sdate=' + sdate + '&edate=' + edate + '&ioType=' + outType + '&unitId=' + rowData.unitId + '&amtType=' + amtType);
