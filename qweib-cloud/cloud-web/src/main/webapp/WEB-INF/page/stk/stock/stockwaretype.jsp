...
<html>
	...
	<body class="easyui-layout">
		...
		<div id="wareTypeDiv" data-options="region:'center'" title="库存信息">
			<iframe src="manager/toStorageWageQuery?isType=0&waretype=0" name="stockWarefrm" id="stockWarefrm" frameborder="0" marginheight="0" marginwidth="0" width="100%" height="100%"></iframe>
		</div>
