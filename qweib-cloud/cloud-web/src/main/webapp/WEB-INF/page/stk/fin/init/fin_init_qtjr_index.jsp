	...
	<script type="text/javascript">
		$('#easyTabs').tabs({
			...
			onSelect:function(title){
				if(title=="供应商借入初始化"){
					document.getElementById("wljkfrm0").src='${base}manager/finInitQtJrMain/toWljrPage?proType=0&bizType=CSHGYSJR';
				}else if(title=="客户借入初始化"){
					document.getElementById("wljkfrm1").src='${base}manager/finInitQtJrMain/toWljrPage?proType=2&bizType=CSHKHJR';
				}else if(title=="员工借入初始化"){
					document.getElementById("wljkfrm2").src='${base}manager/finInitQtJrMain/toWljrPage?proType=1&bizType=CSHYGJR';
				}
			}});
	</script>
</html>
