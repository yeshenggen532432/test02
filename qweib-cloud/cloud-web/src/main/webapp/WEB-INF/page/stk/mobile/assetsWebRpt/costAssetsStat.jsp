fei<%@ page language="java" pageEncoding="UTF-8"%>
...
<html>
		...
		<div class="sctb1" touchmove="queryData()">
			<div class="sctbw" >
				<table width="100%">
					<thead>
						<tr >							
							<td align="center" style="font-size: 11px">费用项目</td>
							<td align="center" style="font-size: 11px">金额 </td>
						<tr >							
	...
	function queryData(){
			...
			var path = "<%=basePath %>/web/assetsWebRpt/costAssetsStat";
			...
			$.ajax({
		        ...
		        success: function (json) {
		        		...
		        		if(size>0){
		        			...
		        			{
		        				text +=  "<tr >";
								text += "<td>" + json.rows[i].type_name + "</td>";
								text += "<td>" + json.rows[i].total_amt + "</td>";
		        				text = text + "</tr>";
		        			}
