		...
		<script type="text/javascript">
		   ...
		   var queryType = 0;//0根据日期条件 1查询所有
			...
			function queryorder(type){
		    	...
		    	if(type == 0)
		    		...
		    		$("#datagrid").datagrid('load',{
						url:"manager/queryRecStat?database="+database,					
						sdate:$("#sdate").val(),
						edate:$("#edate").val(),
						outType:outType
					});
		    ...
		    function onClickCell(index, field, value){
		    	...
		    	parent.closeWin('客户收款统计');
		    	var amtType = "";
		    	if(index == 0&&field=="amt1")amtType = 5;//总收款
		    	if(index == 0&&field=="amt2")amtType = 4;//核销
		    	if(index == 1&&field=="amt1")amtType = 6;//现金
		    	if(index == 2&&field=="amt1")amtType = 1;//银行卡
		    	if(index == 3&&field=="amt1")amtType = 2;//微信
		    	if(index == 4&&field=="amt1")amtType = 3;//支付宝
		    	
		    	if(amtType != "")
			    {
		    		if(amtType == 6)amtType = 0;
		    		parent.add('客户收款统计','manager/toRecUnitStat?sdate=' + sdate + '&edate=' + edate + '&ioType=' + outType + '&amtType=' + amtType);
			    }
