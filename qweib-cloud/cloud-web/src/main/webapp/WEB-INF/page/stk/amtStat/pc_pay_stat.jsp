		   ...
		   var queryType = 0;
			...
			function queryorder(type){
				...
				$("#datagrid").datagrid('load',{
					url:"manager/queryPayStat?database="+database,					
					sdate:$("#sdate").val(),
					edate:$("#edate").val(),
					inType:inType
				});
		    ...
		    function onClickCell(index, field, value){
			    ...
			    { 
		    		...
		    		parent.add('供应商付款统计','manager/toPayUnitStat?sdate=' + sdate + '&edate=' + edate + '&ioType=' + inType + '&amtType=' + amtType);
			    }
