	...
	<tr>
    		<td colspan="6">
    			<table>
    				...
    				<span style="font-size: 10px"><c:if test="${not empty other2}">工商号:${other2 }</c:if></span>
    				</td>
    				<td align="center">
    				 <span style="font-size:18px;color:#000000;font-weight:bold;">
    				 	<c:choose>
    				 		<c:when test="${outType eq '销售出库' }">
    				 		<c:if test="${fn:contains(billNo,'XSFH') }">${printTitle}</c:if>
...
<div id="dlg" closed="true" class="easyui-dialog" title="设置" style="width:400px;height:310px;padding:10px"
			...
			">
		工商号：<input name="other2" id="other2" style="width:240px;height: 20px;" value="${other2}"/>
		<br/>
		单&nbsp;据&nbsp;标&nbsp;题：<input name="printTitle" id="printTitle" style="width:240px;height: 20px;" value="${printTitle}"/>
		<br/>
		咨&nbsp;询&nbsp;电&nbsp;话：<input name="comTel" id="comTel" style="width:120px;height: 20px;" value="${comTel}"/><br />
		备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注1：
		<textarea name="printMemo" id="printMemo" rows="5" cols="40">${printMemo}</textarea><br/>
		备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注2：
		<textarea name="other1" id="other1" rows="5" cols="40">${other1}</textarea>
