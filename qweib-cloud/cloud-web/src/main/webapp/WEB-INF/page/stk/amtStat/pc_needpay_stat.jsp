...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div id="tb" style="padding:5px;height:auto">		     
			...
			日期: <input name="sdate" id="sdate"  onClick="WdatePicker();" style="width: 100px;" readonly="readonly"/>
	         		  <img onclick="WdatePicker({el:'sdate'})" src="resource/skin/datePicker.gif" width="16" height="22" align="absmiddle" style="cursor: pointer;"/>
	         			-
	         		  <input name="edate" id="edate"  onClick="WdatePicker();" style="width: 100px;" value="${edate}" readonly="readonly"/>
	         		  <img onclick="WdatePicker({el:'edate'})" src="resource/skin/datePicker.gif" width="16" height="22" align="absmiddle" style="cursor: pointer;"/>
	        	 入库类型: <select name="outType" id="inType">
		   ...
		   var queryType = 0;
			...
			function queryorder(type){
				...
				$("#datagrid").datagrid('load',{
					url:"manager/queryNeedPayStat?database="+database,					
					sdate:$("#sdate").val(),
					edate:$("#edate").val(),
					inType:outType
				});
		    ...
		    function onClickCell(index, field, value){
		    	...
		    	parent.closeWin('供应商应付款统计');
		    	
		    	
		    	
		    	parent.add('供应商应付款统计','manager/toNeedPayUnitStat?sdate=' + sdate + '&edate=' + edate + '&ioType=' + outType);
