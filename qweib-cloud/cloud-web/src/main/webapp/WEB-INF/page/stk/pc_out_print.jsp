...
<div id="printbtn" style=" width:100%;text-align: center; margin:5px auto;">
    <input id="btnBillMes" value="发票信息" class="easyui-linkbutton" style=" width:70px; height:22px; "
...
<div id="dlg" closed="true" class="easyui-dialog" title="设置" style="width:520px;height:480px;padding:10px"
    ...
    <form:form commandName="printSettings" class="form">
        ...
        <div class="form-item">
            ...
            <div class="form-content">
                <div style="width: 250px">
                    <div id="printMemo"
                         style="height: 100px; max-height: 150px;white-space: pre!important;">${printSettings.printMemo}</div>
                </div>
            </div>
        </div>
        <div class="form-item">
            ...
            <div class="form-content">
                <div style="width: 250px;">
                    <div id="other1"
                         style="height: 100px; max-height: 150px;white-space: pre!important;">${printSettings.other1}</div>
                </div>
            </div>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="form-content">
                <div style="height: 20px;">
                    <input style="width: 100px;" id="pageHeight" type="number" placehoder="纸张高度如470"
...
<script type="text/javascript">
    ...
    function addTemplate() {
        ...
        parent.add('设置模版', 'manager/stkPrintTemplate/page?fdType=1');
    }
