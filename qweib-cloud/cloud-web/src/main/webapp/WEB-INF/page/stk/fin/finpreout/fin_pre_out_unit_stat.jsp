	...
	<body onload="initGrid()">
		...
		<script type="text/javascript">
		    ...
		    //alert(rowData.inQty);
				...
				parent.closeWin('往来单位预付明细');
		    	parent.add('往来单位预付明细','manager/toFinPreOutUnitDetail?sdate=' + sdate + '&edate=' + edate  + '&unitName='+rowData.unitName+'&unitId=' + rowData.unitId + '&amtType=' + amtType);
