...
<div id="tb" style="padding:5px;height:auto">
    ...
    <div>
        ...
        -
        <input name="edate" id="edate"  onClick="WdatePicker();" style="width: 100px;" value="<%= today%>" readonly="readonly"/>
...
<div id="upDiv" class="easyui-window" style="width:500px;height:100px;padding:10px;"
    ...
    <form action="manager/finInitWlYwMain/toUpProviderInitAmt?bizType=${bizType}" id="upFrm" method="post" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    function fromatterDate(v,row){//单据日期
        v = v + "";
        var date = "";
        var month = new Array();
    ...
    function formatterSkStatus(v,row) {//收款状态
    ...
    function formatterUnPayAmt(v,row) {//未付金额
        var totalAmt = row.amt;
        var payAmt = row.payAmt;
        var freeAmt = row.freeAmt;
