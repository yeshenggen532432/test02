...
<html style="font-size: 50px;">
	...
	<head>
		...
		<script src="<%=basePath %>/resource/stkstyle/js/fin_out.js" type="text/javascript" charset="utf-8"></script>
	...
	<body>
		...
		<div class="center">
			...
			<div class="pcl_lib_out">
				<p class="pcl_title">往来借出-${billNo}</p>
						...
						<table id="more_list">
							...
							<c:forEach items="${sublist}" var="item" varStatus="s">
								<tr>
									...
									</td><td><span id="itemName${s.index}">${item.itemName}</span>&nbsp;<a href="javascript:;;" onclick="javascript:dialogCostType(${s.index})" style="color: #00a6fb">选择</a></td>
		...
		<div class="chose_people pcl_chose_people" style="">
			...
			<div class="cp_list2">
				...
				<div class="pcl_3box">
					...
					<div class="pcl_switch">
						<div class="pcl_3box1">
						<div style="height: 350px;overflow: auto;text-align: center">
							<table class="pcl_table">
								<thead>
									<tr>
										<td>客户名称</td>
		...
		<div id="costTypeDlg" closed="true" class="easyui-dialog" style="width:500px; height:200px;" title="科目选择" iconCls="icon-edit">
		</div>
	</body>
	...
	<script type="text/javascript">
		...
		function loadData()
		{
			...
			$.ajax({
				url: path,
				type: "POST",
				data : {"typeName":'其它应收款',"itemName":'其它应收借出款项'},
				dataType: 'json',
				async : false,
