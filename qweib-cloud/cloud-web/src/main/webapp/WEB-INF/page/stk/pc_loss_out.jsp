...
<html style="font-size: 50px;">
	...
	<head>
		...
		<script src="<%=basePath %>/resource/stkstyle/js/pclossout.js" type="text/javascript" charset="utf-8"></script>
		...
		<div class="center">
			<div class="pcl_lib_out">
						...
						<table id="more_list">
							<thead>
								<tr>
									...
									<td>产品规格</td>
									<td>单位</td>
									<td style="display: ${permission:checkUserFieldDisplay('stk.stkOut.lookqty')}">报损数量</td>
									<td style="display: ${permission:checkUserFieldDisplay('stk.stkOut.lookprice')}">单价</td>
									<td style="display: ${permission:checkUserFieldDisplay('stk.stkOut.lookamt')}">折价收入</td>
									<td>生产日期</td>
									<td>有效期</td>
									<td>备注</td>
							...
							<c:forEach items="${warelist}" var="item" varStatus="s">
								<tr>
									...
									<td style="display: ${permission:checkUserFieldDisplay('stk.stkOut.lookqty')}" onkeydown="gjr_toNextRow(this,'edtqty')"><input name="edtqty" type="text" class="pcl_i2" value="${item.qty}" onkeydown="gjr_toNextCell(this,'productDate')" onchange="countAmt()"/></td>
									<td style="display: ${permission:checkUserFieldDisplay('stk.stkOut.lookprice')}"><input name="edtprice" type="text" class="pcl_i2" id="edtprice${s.index}"  value="${item.price}" onchange="countAmt()"/></td>
							...
							<%--<tbody id="chooselist">--%>
								...
								<%--<td>${item.wareGg}</td>--%>
								<%--<td> ${item.unitName} </td>--%>
								<%--<td style="display: ${permission:checkUserFieldDisplay('stk.stkOut.lookprice')}"><input name="edtprice" type="text" class="pcl_i2" value="${item.price}" onchange="countAmt()"/></td>--%>
								<%--<td style="display: ${permission:checkUserFieldDisplay('stk.stkOut.lookqty')}"><input name="edtqty" type="text" class="pcl_i2" value="${item.qty}" onchange="countAmt()"/></td>--%>
								<%--<td style="display: ${permission:checkUserFieldDisplay('stk.stkOut.lookamt')}"><input name="amt" type="text" class="pcl_i2" value="${item.amt}" onchange="countPrice()"/></td>--%>
				...
				<%----%>
							...
							<td id="edtSumAmt" style="display: ${permission:checkUserFieldDisplay('stk.stkOut.lookamt')}">0.00</td>
							<td></td>
							<td></td>
							<td></td>
							<td></td>
	...
	<script type="text/javascript">
		...
		function addTabRow(k){
			...
			$("#more_list tbody").append(
					...
					'</select>'
					+ '</td>'+
					'<td  style="display:'+qtyDisplay+'" onkeydown="gjr_toNextRow(this,\'edtqty\')" ><input id="edtqty'+rowIndex+'"  name="edtqty" type="text" onkeydown="gjr_toNextCell(this,\'edtprice\')" class="pcl_i2" value="1" onchange="countAmt()"/></td>'+
					'<td  style="display:'+priceDisplay+' onkeydown="gjr_toNextRow(this,\'edtprice\')" ><input id="edtprice'+rowIndex+'" onkeydown="gjr_toNextCell(this,\'productDate\')" name="edtprice" type="text" class="pcl_i2"   onchange="countAmt()"/></td>'+
