...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="initGrid()">
		...
		<a class="easyui-linkbutton" iconCls="icon-add" plain="true" href="javascript:newBill();">往来预收开单</a>
		<a class="easyui-linkbutton" iconCls="icon-search" plain="true"  href="javascript:showPayStat();">预收款统计</a>
		</div>	
		<div>
		   ...
		   //$("#billStatus").val("未收货");
			...
			function formatterSt(v,row){
				...
				if(row.list.length>0){
			        ...
			        hl +='<td width="60px;"><b>预收金额</font></b></td>';
			        hl +='</tr>';
		        }
		    ...
		    function newBill()
			{
		    	parent.closeWin('往来预收开单');
				parent.add('往来预收开单','manager/toFinPreInEdit');
			}
			
			function onDblClickRow(rowIndex, rowData)
		    {
					parent.closeWin('往来预收信息' + rowData.id);
		    		parent.add('往来预收信息' + rowData.id,'manager/showFinPreInEdit?billId=' + rowData.id);
		    }
		    ...
		    {
		    	parent.closeWin('预收款统计');
		    	parent.add('预收款统计','manager/toFinPreInUnitStat?dataTp=1');
		    }
