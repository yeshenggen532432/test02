...
<html>
				...
				<table width="100%">
					<thead>
						<tr >				
							...
							<td align="center" style="font-size: 11px">发票单号</td>
							<td align="center" style="font-size: 11px">发票日期</td>
							<td align="center" style="font-size: 11px">所属二批</td>
							<td align="center" style="font-size: 11px">发票金额</td>
							<td align="center" style="font-size: 11px">已收金额</td>
							<td align="center" style="font-size: 11px">已发货金额</td>
							<td align="center" style="font-size: 11px">未发货金额</td>
							<td align="center" style="font-size: 11px">核销金额</td>
						</tr>
						<tr >							
							...
							<td align="center" style="font-size: 11px"></td>
							<td align="center" style="font-size: 11px"></td>
							<td align="center" style="font-size: 11px" id="totalFpAmt"></td>
							<td align="center" style="font-size: 11px" id="totalYsAmt"></td>
							<td align="center" style="font-size: 11px" id="totalYfhAmt"></td>
							<td align="center" style="font-size: 11px" id="totalWfhAmt"></td>
							<td align="center" style="font-size: 11px" id="totalHxAmt"></td>
						</tr>
					</thead>
					<tbody id="dataList">
					</tbody>
	...
	function queryData(){
			...
			var path = "<%=basePath %>/web/arapWebRpt/yshkAmtStat";
			var token = $("#tmptoken").val();
			var khNm = $("#khNm").val();
			$.ajax({
		        url: path,
		        type: "POST",
		        data : {"token":token,"sdate":startDate,"edate":endDate,"unitName":khNm,"page":pageIndex,"rows":20},
		        dataType: 'json',
		        async : false,
		        	...
		        	if(json.state){
		        		...
		        		if(size>0){
		        			for(var i = 0;i < size-1; i++)
		        			{
								...
								text += "<td>" + json.rows[i].epCustomerName + "</td>";
								text += "<td>" + amtformatter(json.rows[i].disAmt) + "</td>";
								text += "<td>" + amtformatter(json.rows[i].recAmt) + "</td>";
								text += "<td>" + amtformatter(json.rows[i].disAmt1) + "</td>";
								text += "<td>" + amtformatter(json.rows[i].needRec) + "</td>";
								text += "<td>" + amtformatter(json.rows[i].freeAmt) + "</td>";
		        				text = text + "</tr>";
		        			}
		        		...
		        		/* 	<td align="center" style="font-size: 11px" id="totalFpAmt"></td>
        					...
        					$("#totalFpAmt").html(amtformatter(json.rows[i].disAmt));
        					$("#totalYsAmt").html(amtformatter(json.rows[i].recAmt));
        					$("#totalYfhAmt").html(amtformatter(json.rows[i].disAmt1));
        					$("#totalWfhAmt").html(amtformatter(json.rows[i].needRec));
        					$("#totalHxAmt").html(amtformatter(json.rows[i].freeAmt));
		        		}else{
