...
<html style="font-size: 50px;">
	...
	<body>
		...
		<div class="center">
			...
			<p class="pcl_title">借出退货单-${stkSend.voucherNo}-<c:if test="${stkSend.status eq 2 }"><span style="color: red">作废单</span></c:if><c:if test="${stkSend.status ne 2 }"><span style="color: green">正常单</span></c:if></p>
