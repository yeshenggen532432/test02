		   ...
		   var queryType = 0;
		    function initGrid()
		    {
			    ...
			    if(${stkRight.amtFlag} == 0)
		    	    ...
		    	    $('#datagrid').datagrid({
		    	    	url:"manager/queryFinInNeedPayStat",
		    	    	queryParams:{							
							sdate:$("#sdate").val(),
							edate:$("#edate").val()
			...
			function queryorder(type){
				...
				$("#datagrid").datagrid('load',{
					url:"manager/queryFinInNeedPayStat?database="+database,					
					sdate:$("#sdate").val(),
					edate:$("#edate").val()
				});
			    	}
			    	...
			    	{
		    		$("#datagrid").datagrid('load',{
						url:"manager/toFinInNeedPayStat?database="+database,					
						sdate:"",
						edate:"",
						inType:""
					});
		    ...
		    function onClickCell(index, field, value){
		    	...
		    	parent.add('往来应收款统计','manager/toFinInNeedPayUnitStat?sdate=' + sdate + '&edate=' + edate );
