...
<html style="font-size: 50px;">
	...
	<head>
		...
		<script src="<%=basePath %>/resource/stkstyle/js/fin_pre_out.js" type="text/javascript" charset="utf-8"></script>
	...
	<body>
		...
		<div class="center">
			...
			<div class="pcl_lib_out">
				<p class="pcl_title">往来预付-${billNo}</p>
	...
	<script type="text/javascript">
		...
		function loadData()
		{
			...
			$.ajax({
				url: path,
				type: "POST",
				data : {"typeName":'预付账款',"itemName":'其他预付账款'},
				dataType: 'json',
				async : false,
