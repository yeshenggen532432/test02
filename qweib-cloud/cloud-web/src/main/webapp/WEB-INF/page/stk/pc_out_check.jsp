						...
						<div class="pcl_right_edi" style="width: 400px;">
							<div class="pcl_right_edi_w">
								<div>
									...
									<input type="text" id="billstatus"   style="color:green;width:70px;" readonly="readonly" value="${billstatus}"/>
									<input type="text" id="paystatus"   style="color:green;width:60px;display: none" readonly="readonly" value="${paystatus}"/>
								</div>
							</div>
					...
					<table>
						<tbody>
							...
							<tr>
								...
								<td><font color="red">发货时间：</font></td>
								<td>
								...
								<td>
									...
									<tr>
										...
										<td>
											...
											<input type="hidden" id="epCustomerId"  name="epCustomerId" value="${epCustomerId }"/>
											<input type="text" id="epCustomerName"  name="epCustomerName" required="required" placeholder="单击选择客户" value="${epCustomerName }" readonly="readonly"/>
											</div>
										</td>
									</tr>
								</table>
							...
							<c:if test="${saleType eq '003'}">
								<tr>
									<td>物流名称：</td>
									<td>
										<div class="pcl_input_box pcl_w2"><input type="text" id="transportName" value="${transportName}"></div>
									</td>
									<td>物流单号：</td>
									<td>
										<div class="pcl_input_box pcl_w2"><input type="text" id="transportCode" value="${transportCode}"></div>
									</td>
									<td></td>
									<td></td>
								</tr>
					...
					<div class="pcl_lfbox1">
						<table id="more_list">
							...
							<tbody id="chooselist">
								...
								<td><input name="edtoutqty" type="text" class="pcl_i2" value="${item.outQty1}"  style="color:red"/></td>
								...
								<input id="sswId${s.index}" name="sswId" type="text" value="${item.sswId}" />
								</td>
								<td>
	...
	<script type="text/javascript">
		...
		function auditProc()
		{
		    ...
		    $.ajax({
		        url: path,
		        type: "POST",
		        data : {"token":"","billId":billId,"transportName":transportName,"transportCode":transportCode,"sendTimeStr":sendTime,"vehId":vehId,"driverId":driverId,"remarks":remarks,"wareStr":JSON.stringify(wareList)},
		        dataType: 'json',
		        async : false,
		        success: function (json) {
		        	if(json.state){
		        		...
		        		gEditState = 1;
		        		window.location.href='lookstkoutcheck?dataTp=1&billId=' + billId+'&sendId='+json.sendId;
		        	}
		        	else
		        	{
		        		alert("发货失败:" + json.msg);
