	...
	<body class="bg1">
		...
		<div class="from_tb">
			<table>
				<tr>
					<td width="25%">收货对象</td>
					<td><a href="javascript:;" style="display: inline-block;width: 90%;" class="color_999" id="lib_supplier">${khNm}</a></td>
				</tr>
			...
			<div class="tbox">
				...
				<div class="tbbb">
					<table id="more_list">
						...
						<td>${item.unitName}<input  type="hidden" name="subId"  value="${item.id}"/></td>
						<td>${item.outQty}</td>
	...
	<script type="text/javascript">
		...
		function submitCheck()
		{
			...
			for (var i=0;i<trList.length;i++) {
			    ...
			    var xsTp = "";//tdArr.eq(2).find("a").text();
			    var qty = tdArr.eq(1).find("input").val();
			    var outQty = tdArr.eq(4).find("input").val();
