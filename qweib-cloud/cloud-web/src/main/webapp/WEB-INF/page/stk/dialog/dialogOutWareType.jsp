...
<html>
	...
	<table width="100%"  border="0" cellpadding="0" cellspacing="0" >
	 ...
	 <td valign="top" align="left">
			<iframe src="${base}/manager/toDialogOutWarePage?isType=0&stkId=${stkId}&op=${param.op}&customerId=${customerId}" name="warefrm" id="warefrm" frameborder="0" marginheight="0" marginwidth="0" width="100%" height="360px"></iframe>
	</td>
	</tr>
	</table>	
		<script type="text/javascript">
			...
			function toShowWare(id,isType){
				document.getElementById("warefrm").src="${base}/manager/toDialogOutWarePage?isType="+isType+"&stkId=${stkId}&op=${param.op}&customerId=${customerId}&waretype="+id;
			}
		</script>
	</body>
</html>
