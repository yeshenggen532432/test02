...
<html style="font-size: 50px;">
	...
	<head>
		...
		<script src="<%=basePath %>/resource/stkstyle/js/fin_in.js" type="text/javascript" charset="utf-8"></script>
	...
	<body>
		...
		<div class="center">
			...
			<div class="pcl_lib_out">
				<p class="pcl_title">往来借入-${billNo}</p>
	...
	<script type="text/javascript">
		...
		function queryItem(typeId){
			$("#itemgrid").datagrid('load',{
				url:"<%=basePath%>/manager/queryUseIoItemList",
				typeId:typeId
			});
		}
		...
		function loadData()
		{
			...
			$.ajax({
				url: path,
				type: "POST",
				data : {"typeName":'其它应付款',"itemName":'其它应付借入款项'},
				dataType: 'json',
				async : false,
