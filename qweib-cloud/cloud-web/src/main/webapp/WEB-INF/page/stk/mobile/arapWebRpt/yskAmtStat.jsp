...
<html>
	...
	function queryData(){
			...
			var path = "<%=basePath %>/web/arapWebRpt/yskAmtStat";
		        ...
		        success: function (json) {
		        	if(json.state){
		        		...
		        		if(size>0){
        					...
        					$("#totalFhAmt").html(amtformatter(json.rows[i].disamt1));
        					$("#totalYsAmt").html(amtformatter(json.rows[i].recamt));
        					$("#totalHxAmt").html(amtformatter(json.rows[i].freeamt));
        					$("#totalQkAmt").html(amtformatter(json.rows[i].sumamt));
		        		}else{
