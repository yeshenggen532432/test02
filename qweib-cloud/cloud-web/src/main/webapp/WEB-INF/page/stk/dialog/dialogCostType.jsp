	...
	<table width="100%" height="100%" border="0" cellpadding="0"
			...
			<tr valign="top" align="left">
				...
				<table id="costTypeId" class="easyui-datagrid" fit="true" singleSelect="true"
					url="<%=basePath%>/manager/queryCostTypeList" title=""  border="false" rownumbers="true"
		 ...
		 <td valign="top" align="left">
				<table id="itemgrid" class="easyui-datagrid" fit="true" singleSelect="true"
						url="<%=basePath%>/manager/queryCostItemList" title="" iconCls="icon-save" border="false" rownumbers="true"
