...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div>
			...
			单据日期: <input name="sdate" id="sdate"  onClick="WdatePicker();" style="width: 100px;display: none"  readonly="readonly"/>
		...
		<script type="text/javascript">
			...
			function query(){
				$("#datagrid").datagrid('load',{
					url:"manager/queryFinOutTotal?database="+database,
					jz:"1",
					proName:$("#proName").val(),
					sdate:$("#sdate").val(),
					edate:$("#edate").val()
			...
			function onDblClickRow(rowIndex, rowData)
		    {
				...
				parent.closeWin('应回款统计明细' + rowData.id);
		    	parent.add('应回款统计明细' + proId,'manager/toFinOutTotalItem?proId='+proId+'&proName='+proName+'&sdate='+sdate+'&edate='+edate+'');
