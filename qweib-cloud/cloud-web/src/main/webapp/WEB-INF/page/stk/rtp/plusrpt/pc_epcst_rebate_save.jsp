...
;
			 ...
			 //alert(JSON.stringify(cols));
			 	...
			 	var paramStr = dateTypeStr + ":" + sdate + "-" + edate + " 销售类型:" + outType + " 客户名称:" + khNm +  " 客户类型:" + customerType + " 商品名称:" + wareNm;
			 	var merCols = 'khNm';
        		...
        		url: path,
        		type: "POST",
        		data : {"rptTitle":$("#rptTitle").val(),"remark":$("#remark").val(),"rptType":9,"saveHtml":dataStr},
        		dataType: 'json',
        		async : false,
        		success: function (data) {
        		data = eval(data);
