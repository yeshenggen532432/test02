...
<html style="font-size: 50px;">
	...
	<head>
		...
		<script src="<%=basePath %>/resource/stkstyle/js/pcborrowout.js" type="text/javascript" charset="utf-8"></script>
						...
						<table id="more_list">
							<thead>
								<tr>
									...
									<td>产品规格</td>
									<td>单位</td>
									<td style="display: ${permission:checkUserFieldDisplay('stk.stkOut.lookqty')}">借出数量</td>
									<td style="display: ${permission:checkUserFieldDisplay('stk.stkOut.lookprice')}">单价</td>
									<td style="display: ${permission:checkUserFieldDisplay('stk.stkOut.lookamt')}">借出金额</td>
									<td>生产日期</td>
									<td>有效期</td>
									<td>备注</td>
							...
							<c:forEach items="${warelist}" var="item" varStatus="s">
								<tr>
									...
									<td onkeydown="gjr_toNextRow(this,'edtqty')"><input type="text" class="pcl_i2"
																						  value="${item.wareGg}"
									...
									<td style="display: ${permission:checkUserFieldDisplay('stk.stkOut.lookqty')}" onkeydown="gjr_toNextRow(this,'edtqty')"><input name="edtqty" type="text" class="pcl_i2" value="${item.qty}" onkeydown="gjr_toNextCell(this,'edtprice')"  onchange="countAmt()"/></td>
									<td style="display: ${permission:checkUserFieldDisplay('stk.stkOut.lookprice')}"><input name="edtprice" type="text" class="pcl_i2" id="edtprice${s.index}" onkeydown="gjr_toNextCell(this,'productDate')"  value="${item.price}" onchange="countAmt()"/></td>
