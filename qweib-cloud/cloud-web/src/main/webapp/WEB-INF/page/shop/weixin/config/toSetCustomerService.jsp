...
<table id="datagrid" class="easyui-datagrid" fit="true" singleSelect="false"
    ...
    <tr>
        ...
        <th field="isCustomerService" width="80" align="center" formatter="formatterIsCustomerService">
            是否客服
        </th>
...
<div id="tb" style="padding:5px;height:auto">
    ...
    <c:if test="${dataTp!=3}">
        <c:if test="${!empty info.datasource}">
            <a class="easyui-linkbutton" iconCls="icon-ok" plain="true"  href="javascript:setSelectedCustomerService();">设置选中的员工为客服</a>
            <a class="easyui-linkbutton" iconCls="icon-delete" plain="true"  href="javascript:setSelectedNotCustomerService();">设置选中的员工取消客服</a>
        </c:if>
    </c:if>
</div>
<div class="file-box">
...
<script type="text/javascript">
    ...
    var dataTp = "${dataTp}";
    function formatterIsCustomerService(val,row){
        if(val==1){
            return "是";
        }else{
            return "否";
    ...
    function setSelectedCustomerService() {
        ...
        if (ids.length > 0) {
            $.messager.confirm('确认', '您确认要设置选中的员工为客服吗？', function(r) {
                if (r) {
                    $.ajax( {
    ...
    function setSelectedNotCustomerService() {
        ...
        if (ids.length > 0) {
            $.messager.confirm('确认', '您确认要取消设置选中的员工为客服吗？', function(r) {
                if (r) {
                    $.ajax( {
