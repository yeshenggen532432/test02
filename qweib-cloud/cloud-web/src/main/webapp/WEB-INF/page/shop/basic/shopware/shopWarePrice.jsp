...
<html>
	...
	<body class="easyui-layout">
		...
		<div id="wareTypeDiv" data-options="region:'center'">
			<iframe src="manager/shopWare/toShopWarePricePage" name="warefrm" id="warefrm" frameborder="0" marginheight="0" marginwidth="0" width="100%" height="100%"></iframe>
		</div>
		<script type="text/javascript">
			//点击商品分类树查询
			function toShowWare(id){
				document.getElementById("warefrm").src="${base}/manager/shopWare/toShopWarePricePage?wareType="+id;
			}
		</script>
	</body>
</html>
