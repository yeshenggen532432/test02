...
<body>
	...
	<div id="tb" style="padding:5px;height:auto">
		...
		<a class="easyui-linkbutton" iconCls="icon-edit" plain="true" href="javascript:doFinish();">确认收货</a>
	...
	<script type="text/javascript">
		...
		function queryorder(){
			...
			cols.push(col);
			$('#datagrid').datagrid({
				url:"manager/shopBforder/unFinishOrderPage",
				nowrap:false,
				cache:false,
				border: false,
				rownumbers: true,
		...
		function doFinish() {
			...
			if (ids.length > 0) {
				$.messager.confirm('确认', '您确认收货订单记录吗？', function(r) {
					if (r) {
						$.ajax( {
							url : "manager/shopBforder/doFinish",
							data : "id=" + ids,
							type : "post",
