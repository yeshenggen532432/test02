...
<div id="tb" style="padding:5px;height:25px;">
	...
	<a style="margin-left: 30px;" class="easyui-linkbutton"  plain="true" iconCls="icon-search" href="javascript:checkCompleteCustomerServiceChatWithMember();">查看已完成的客服聊天</a>
	<%--<a style="margin-left: 30px;" class="easyui-linkbutton"  plain="true" iconCls="icon-search" href="javascript:queryCustomerServiceChatWithMemberRpt();">客服聊天报表</a>--%>
</div>
<!--未读消息会员列表-->
...
<div id="responseMsgDiv" class="responseMsgDiv">
	<a style="margin-left: 10px;" class="easyui-linkbutton"  plain="true" iconCls="icon-telephone" href="javascript:customerServiceChatWithCurrentMember();">接入聊天</a>
</div>
<!--客服申请聊天窗口-->
<div id="requestChatDiv" class="requestChatDiv">
	<a style="margin-left: 10px;" class="easyui-linkbutton"  plain="true" iconCls="icon-telephone" href="javascript:requestChatWithCurrentMember();">申请聊天</a>
</div>
<!--客服发送消息窗口-->
<div id="sendTextMsgDiv" class="sendTextMsgDiv">
	<a style="margin-left: 10px;" class="easyui-linkbutton"  plain="true" iconCls="icon-telephone" href="javascript:requestChangeCustomerService();">转接</a>
	<a style="margin-left: 10px;" class="easyui-linkbutton"  plain="true" iconCls="icon-undo" href="javascript:quitCurrentMemberChat();">退出</a>
	<a style="margin-left: 10px;" class="easyui-linkbutton"  plain="true" iconCls="icon-ok" href="javascript:completeCurrentMemberChat();">完成</a>
	<textarea class="reg_input" name="sendMsgTextareea" id="sendMsgTextareea" style="width:300px;height:200px;margin-left: 5px;margin-top: 60px;"></textarea>
	<span id="sendMsgTextareeaTip" class="onshow"></span>
	<a style="text-align:center;margin-top: 60px;margin-left: 120px;width:100px;" class="easyui-linkbutton"  plain="false" iconCls="icon-ok" href="javascript:sendTextMsg();">发送</a>
</div>

<!--选择申请客服窗口-->
<div id="chooseRequestCustomerServiceDiv" class="easyui-window" style="width:600px;height:420px;padding:10px;"
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr height="40px">
				<td align="center" colspan="2">
					<a class="easyui-linkbutton" href="javascript:requestChangeCustomer();">申请</a>
...
<!--申请与会员聊天，选择申请客服窗口-->
<div id="chooseRequestCustomerServiceDiv_1" class="easyui-window" style="width:600px;height:420px;padding:10px;"
	 minimizable="false" maximizable="false" collapsible="false" closed="true">
	<input  type="hidden" name="openIdKey" id="openIdKey_1"/>
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr height="20px">
		</tr>
		<tr>
		...
		<tr height="40px">
			<td align="center" colspan="2">
				<a class="easyui-linkbutton" href="javascript:requestChangeCustomer_1();">申请</a>
				<a class="easyui-linkbutton" href="javascript:hideMsgWin_1();">关闭</a>
			</td>
		</tr>
	</table>
</div>
...
<script type="text/javascript">
	...
	if('WebSocket' in window){
	    ...
	    alert("当前浏览器不支持websocket，无法与微信会员聊天，请升级浏览器!");
	}
                                ...
                                if(json.state == 2){//多客服,选择申请客服
                                    ...
                                    $.each(customerServiceList,function(n,value) {
                                        if(value.memberId != "${customerServiceId}"){//当前在线客服不是当前会员客服
                                            ...
                                            <!--选择客服按钮-->;
                                            strs+="<input type='button' class='chooseCustomerServiceButton' value='选择'  onclick='setCustomerService_1("+value.memberId+",\""+value.memberNm+"\")'></input>";
                                            $("#CustomerServiceDiv_1").append(strs);
                                        }
                                    });
                                }else{
                                    alert(json.msg);
                            ...
                            if (json.state == 1) {//公司有其他在线客服!
                                ...
                                $.each(customerServiceList,function(n,value) {
                                    if(value.memberId != "${customerServiceId}"){//当前在线客服不是当前会员客服
                                        ...
                                        $("#CustomerServiceDiv").append(strs);
									}
                                });
                                /*  //添加公司其他的在线客服
								var strs="<div  class='onlineCustomerServiceDiv'>";
