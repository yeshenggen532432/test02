...
<div id="tb" style="padding:5px;height:auto">
	...
	<input type="hidden" name="isJxc" id="isJxc" value="${isJxc}"/>
...
<script type="text/javascript">
	...
	function initGrid(){
		...
		cols.push(col);*/
		$('#datagrid').datagrid({
			url:"manager/shopMemberPrice/shopWareGradePricePage?wareType=${wareType}&gradeId=${gradeId}",
			columns:[
				cols
			]}
		);
	...
	function changePrice(obj, wareId) {
		...
		$.ajax({
			url: "manager/shopMemberPrice/updateShopMemeberGradePrice?gradeId=${gradeId}",
			type: "post",
			data:{
				"wareId":wareId,
				"shopWarePrice":price,
