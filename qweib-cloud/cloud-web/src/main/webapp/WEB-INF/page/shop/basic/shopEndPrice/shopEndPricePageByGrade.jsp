...
<table id="dataGridWare" class="easyui-datagrid" fit="true" singleSelect="false"
       url="manager/shopEndPrice/shopWareEndPricePageByGradeId?gradeId=${gradeId}&wareType=${wareType}" border="false"
    ...
    <tr>
        ...
        <c:if test="${isJxc==1}">
            <th field="shopWareSmallPrice" width="120" align="center" styler=cellStyler4 formatter="formatterMinPrice">
                商城批发价(小)
            </th>
        </c:if>
...
<script type="text/javascript">
    ...
    function queryWare(){
        $("#dataGridWare").datagrid('load',{
            url:"manager/shopEndPrice/shopWareEndPricePageByGradeId?gradeId=${gradeId}&wareType=${wareType}",
            wareNm:$("#wareNm").val(),
        });
    }
