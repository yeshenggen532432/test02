...
<html>
	...
	<body class="easyui-layout">
		...
		<div id="wareTypeDiv" data-options="region:'center'">
			<iframe src="${base}/manager/shopCityWare/shopSelectWarePage" name="warefrm" id="warefrm" frameborder="0" marginheight="0" marginwidth="0" width="100%" height="100%"></iframe>
		</div>
		<script type="text/javascript">
			//点击商品分类树查询
			function toShowWare(id){
				document.getElementById("warefrm").src="${base}/manager/shopCityWare/shopSelectWarePage?waretype="+id;
			}
		</script>
	</body>
</html>
