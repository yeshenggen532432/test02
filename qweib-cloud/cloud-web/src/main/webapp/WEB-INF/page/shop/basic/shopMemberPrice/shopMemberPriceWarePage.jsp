...
<div id="tb" style="padding:5px;height:auto">
	...
	<input type="hidden" name="shopMemberId" id="shopMemberId" value="${shopMemberId}"/>
...
<script type="text/javascript">
	...
	function initGrid(){
		...
		cols.push(col);*/
		$('#datagrid').datagrid({
			url:"manager/shopMemberPrice/queryShopMemberPriceByShopMemberId?wareType=${wareType}&shopMemberId=${shopMemberId}",
			columns:[
				cols
			]}
		);
	...
	function changePrice(obj, wareId) {
		...
		$.ajax({
			url: "manager/shopMemberPrice/updateShopMemeberPrice?shopMemberId=${shopMemberId}",
			type: "post",
			data:{
				"wareId":wareId,
				"shopWarePrice":price,
