            ...
            <div class="center-part">
                ...
                <div class="center-items chart0 clearfix">
                    <div class="chart0-item">
                        <div class="item-inner">
                            <div class="item-content">
                                <div class="content-hd">卡数量分布图</div>
                    ...
                    <div class="chart0-item">
                        <div class="item-inner">
                            <div class="item-content">
                                <div class="content-hd">卡金额分布图</div>
                ...
                <div class="center-items chart1">
                    <div class="chart1-inner">
                        <div class="item-hd">年月新客户变化图</div>
...
<script type="text/javascript">
    ...
    function  querySaleAnalyse() {
        $.ajax({
            ...
            success:function(data){
                if(data){
                    var list = data.rows;
                    var qtyLabel = new Array();
                    var qtyValue = new Array();
                    var amtValue = new Array();
                    for(var i = 0;i<list.length;i++)
                    {
                        var typeName = list[i].typeName;
                        var qty = list[i].qty;
                        var amt = list[i].amt;
                        qtyLabel.push(typeName);
                        var subObj = {
                            name: typeName,
                            value: qty
                        };
                        ...
                        qtyValue.push(subObj);
                        amtValue.push(subObj1);

                    }
                    refreshPie(qtyLabel,qtyValue,qtyLabel,amtValue);
    ...
    function refreshPie(titleArray1,valueArray1,titleArray2,valueArray2)
    {
