...
<div data-options="region:'west',split:true,title:'商品分类树'"
    ...
    <ul id="waretypetree" class="easyui-tree"
        data-options="url:'manager/pos/syswaretypes',animate:true,dnd:true,onClick: function(node){
        ...
        $("#datagrid").datagrid({
            ...
            columns: [[
                ...
                {field: 'disPrice2', title: '小单位促销价', width: 90},
                 {field: 'wareDj', title: '大单位批发价', width: 90},
                 {field: 'sunitPrice', title: '小单位批发价', width: 90}
            ]],
