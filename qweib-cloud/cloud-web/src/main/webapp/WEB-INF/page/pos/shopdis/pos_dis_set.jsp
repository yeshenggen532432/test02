...
<body onload="queryShopRate();">
<table id="datagrid" class="easyui-datagrid" fit="true" singleSelect="true"
       url="" title="门店促销列表" iconCls="icon-save" border="false"
...
<script type="text/javascript">
    ...
    function queryShopRate(){
         $('#datagrid').datagrid({
            url:"manager/pos/queryPosDisSet",
            queryParams:{
                shopNo: $("#shopName").val()
    ...
    function toEditShopRate(id){
      ...
      //  $('#editdlg').dialog('open');
        location.href="${base}/manager/pos/toPosShopDisSetEdit?id="+id;
    }
