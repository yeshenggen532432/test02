...
<script type="text/javascript">
    ...
    function todetail(id)
    {
        ...
        if(gShopNo == "")
        parent.add('会员消费明细' + id,'${base}manager/pos/toPosCardCostDetail?cardId=' + id + '&sdate=' + sdate + '&edate=' + edate + '&operator=' + operator
        +'&shopNo=' + shopNo ) ;
        else parent.parent.add('会员消费明细' + id,'${base}manager/pos/toPosCardCostDetail?cardId=' + id + '&sdate=' + sdate + '&edate=' + edate + '&operator=' + operator
            +'&shopNo=' + shopNo ) ;
    }
