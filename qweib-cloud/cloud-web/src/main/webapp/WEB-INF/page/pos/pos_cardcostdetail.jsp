...
<div id="tb" style="padding:5px;height:auto">
    ...
    姓名: <input name="cstName" id="cstName" style="width:120px;height: 20px;" onkeydown="toQuery(event);" value="${name}"/>
    卡号: <input name="cardNo" id="cardNo" style="width:120px;height: 20px;" onkeydown="toQuery(event);" value="${cardNo}"/>
    电话: <input name="mobile" id="mobile" style="width:120px;height: 20px;" onkeydown="toQuery(event);" value="${mobile}"/>
    收银员: <input name="operator" id="operator" style="width:120px;height: 20px;" onkeydown="toQuery(event);" value="${operator}"/>
    ...
    卡类型: <select name="cardTypeSel" id="cardTypeSel">
    ...
    function loadCardType(){
        $.ajax({
            ...
            success:function(data){
                if(data){
                    var list = data.rows;
                    var objSelect = document.getElementById("cardTypeSel");
                    objSelect.options.add(new Option(''),'');
                    for(var i = 0;i < list.length; i++)
                    {
