...
<div class="box">
    <form action="manager/pos/savePosCardDisSet" name="BonusSharfrm" id="BonusSharfrm" method="post">
        <input  type="hidden" name="id" id="id" value="${cardRate.id}"/>

        <dl id="dl">

            <dt class="f14 b">促销信息</dt>
            <div class="box" >
                <input type="hidden" id="status" name = "status" value="${cardRate.status}">
                <dd>
                    <span class="title">连锁店*：</span>
                    <tag:select id="shopNo" name="shopNo" displayKey="shop_no"  displayValue="shop_name" tableName="pos_shopinfo"/>
                </dd>

                <dd>
                    <span class="title">卡类型*：</span>
                    <tag:select id="cardType" name="cardType" displayKey="id"  displayValue="type_name" tableName="shop_member_type"/>
                </dd>
                ...
                <dd>
                    ...
                    <div id="wareDiv"><span class="title">打折对象：</span>
                        <input class="reg_input" name="objName" id="objName" value="${cardRate.objName}" readonly="readonly"  style="width: 120px"/>
                        <a class="easyui-linkbutton" iconCls="icon-add" plain="true" href="javascript:dialogSelectWare();">选择</a>
                    </div>
                    <input type = "hidden" id="objId" name="objId" value="${cardRate.objId}"/>
                </dd>
                <dd>
                    <span class="title">折扣：</span>
                    <input class="reg_input" name="rate" id="rate" value="${cardRate.rate}"  style="width: 120px"/>%
                ...
                <dd>
                    ...
                    <input name="startTimeStr" id="startTimeStr"  onClick="WdatePicker({skin:'whyGreen',dateFmt: 'yyyy-MM-dd HH:mm:ss'});" style="width: 100px;" value="${cardRate.startTimeStr}" readonly="readonly"/>
                ...
                <dd>
                    ...
                    <input name="endTimeStr" id="endTimeStr"  onClick="WdatePicker({skin:'whyGreen',dateFmt: 'yyyy-MM-dd HH:mm:ss'});" style="width: 100px;" value="${cardRate.endTimeStr}" readonly="readonly"/>
                    <img onclick="WdatePicker({skin:'whyGreen',dateFmt: 'yyyy-MM-dd HH:mm:ss'});" src="resource/skin/datePicker.gif" width="16" height="22" align="absmiddle" style="cursor: pointer;"/>
...
<script type="text/javascript">
    function initShow()
    {
        ...
        if($("#id").val() > 0)
        {
            $("#shopNo").val(${cardRate.shopNo});
            $("#rateType").val(${cardRate.rateType});
            $("#cardType").val(${cardRate.cardType});
    ...
    function toback(){
        ...
        location.href="${base}/manager/pos/toPosCardDisSet";
    }
