        ...
        <div class="mui-scroll-wrapper">
            <div class="mui-scroll">
                ...
                <ul class="mui-table-view mui-table-view-chevron" style="margin-top: 10px">
                    ...
                    <li class="mui-table-view-cell">
                        <a href="javaScript:toMyOrder();" class="mui-navigate-right"><span class="mui-icon iconfont icon-icon--copy"></span>我的消费记录</a>
                    </li>
                    <li class="mui-table-view-cell">
                    ...
                    <li class="mui-table-view-cell">
                        <a href="javaScript:toRechargeList();" class="mui-navigate-right"><span class="mui-icon iconfont icon-chongzhijilu1"></span>账户明细</a>
                    </li>
                </ul>
            </div>
        </div>
...
<script>
        ...
        $.ajax({
            ...
            success: function (json) {
                if(json.state){
                    ...
                    $(".my_amount").text("余额：" + cardAmt + "元(赠送" + json.freeCost + ")");
                }
            }
        });
    }
    ...
    function toMyOrder(){
        ...
        window.location.href = '<%=basePath%>/web/toWxBillList?token=${token}';
    }
    function toAddress(){
    ...
    function toRechargeList(){
        ...
        window.location.href = '<%=basePath %>/web/toCardIoList?token=${token}';
    }
