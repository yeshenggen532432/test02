...
<div id="wareTypeDiv" data-options="region:'center'" title="会员列表">
    ...
    <div id="tb" style="padding:5px;height:auto">
        ...
        <a class="easyui-linkbutton" iconCls="icon-edit"  href="javascript:initclick();">扣款</a>
...
<div id="dlg" closed="true" class="easyui-dialog" title="会员扣款" style="width:400px;height:200px;padding:10px"
     data-options="
				iconCls: 'icon-save',
    ...
    <div class="box">
        <dd>
            <span class="title">消费金额:</span> <input name="costAmt" id="costAmt" style="width:120px;height: 20px;" />
        </dd>
        <dd>
            <span class="title">手工单号:</span>  <input name="docNo" id="docNo" style="width:120px;height: 20px;" />
        </dd>
    </div>
...
<script type="text/javascript">
    ...
    function initProc1(){
        ...
        $.ajax({
            url:"manager/pos/cardConsumeProc",
            type:"post",
            data:"id="+id+"&costAmt=" + costAmt + "&docNo=" + $("#docNo").val() + "&shopNo=9999",
