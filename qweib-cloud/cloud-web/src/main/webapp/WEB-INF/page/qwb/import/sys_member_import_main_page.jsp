...
<body>
    <table id="datagrid" class="easyui-datagrid" fit="true" singleSelect="false"
           url="manager/sysMemberImportMain/page" border="false"
   ...
   <%-- <div id="gridbar">
        <div style="padding: 2px">
            <a   class="easyui-linkbutton" plain="true" iconCls="icon-redo" href="javascript:toMemberModel();">下载模板</a>
            <a   class="easyui-linkbutton" plain="true" iconCls="icon-redo" href="javascript:toUpMember();">上传数据</a>
        </div>
    </div>--%>
...
<script type="text/javascript">
    ...
    function query() {
        $("#datagrid").datagrid('load', {
            url: "manager/sysMemberImportMain/page"
        });
    }
    ...
    function toMemberModel() {
        if (confirm("是否下载模版?")) {
            window.location.href = "manager/toLoadModel";
        }
    ...
    function onDblClickRow(rowIndex, rowData) {
        ...
        parent.add(rowData.title, 'manager/sysMemberImportMain/toSubPage?mastId=' + rowData.id);
    }
