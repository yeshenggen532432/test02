...
<table id="datagrid"  class="easyui-datagrid"  fit="true" singleSelect="false"
	...
	<tr>
		...
		<th field="_operater" width="120" align="center" formatter="formatterOper">
			操作
		</th>
	</tr>
	</thead>
...
<script type="text/javascript">
	...
	function formatterOper(val,row){
		return "<a href='javascript:;;' onclick='setWarePrice(\""+row.id+"\",\""+row.khNm+"\")'>设置费用<a/>"
	}

	function setWarePrice(id,name){
		window.parent.close(name+"_设置费用");
		window.parent.add(name+"_设置费用","manager/autopricecustomerwaretype?customerId="+id);
	}
