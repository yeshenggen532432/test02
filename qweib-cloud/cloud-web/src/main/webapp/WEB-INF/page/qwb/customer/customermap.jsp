...
<body>  
    <div class="demo_main">  
        <fieldset class="demo_title">  
            客户：<input name="khNm" id="khNm" style="width: 100px;" type="text"/>
            业务员：<input name="memberNm" id="memberNm" style="width: 100px;" type="text"/>
           <input type="button" value="查询" onclick="toquerycmap();"/>  
            ...
            <script type="text/javascript">  
                ...
                function addMarker(point, index) {
                  var myIcon = new BMap.Icon("${base}upload/attached/qwbred.png",  
                        new BMap.Size(22, 25));  
