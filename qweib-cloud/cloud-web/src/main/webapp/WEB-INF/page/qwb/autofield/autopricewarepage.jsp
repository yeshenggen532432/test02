		...
		<script type="text/javascript">
		 ...
		 function initGrid()
		    ...
		    function formatAutoAmt(val,row,index){
		    	...
		    	var html = "<input type='hidden' id='auto_price_Id_"+row.wareId+"_"+this.value+"'/>";
					html+="<input style='display:none' class="+this.field+"_imput"+" name='autoPrice' size='7' onchange='changeWareAutoPrice("+row.wareId+","+this.value+")' id='auto_Price_"+row.wareId+"_"+this.value+"' value='"+price+"' />";
		    		...
		    		for(var i=0;i<autoPriceDatas.length;i++){
		    			...
		    			if(json.wareId==row.wareId&&json.autoId==this.value){
		    				html ="<input type='hidden' id='auto_price_Id_"+row.wareId+"_"+this.value+"' value='"+json.id+"'/>";
							html+="<input style='display:none' class="+this.field+"_imput"+" name='autoPrice' size='7' onchange='changeWareAutoPrice("+row.wareId+","+this.value+")' id='auto_Price_"+row.wareId+"_"+this.value+"' value='"+json.price+"' />";
