...
<div id="treeDiv_role" class="easyui-window" style="width:420px;height:580px;"
    ...
    <form name="menufrm_role" id="menufrm_role" method="post">
        ...
        <div id="divHYGL_role" class="menuTree" data-options="region:'north'"
             style="width: 400px;height:510px;overflow: auto;padding-left: 5px;">
...
<script type="text/javascript">
    ...
    function loadTree_menu_role(treeName, objDiv, title, data, roleId, creatorAndAdmin) {
        ...
        var objTree = new dTree(treeName);
        ...
        if (data) {
            for (var i = 0; i < data.length; i++) {
                ...
                var isSpecificMenu = data[i].specificTag && data[i].specificTag.length > 0;
                ...
                if (creatorAndAdmin || isSpecificMenu) {
                    chosevalue += " disabled/>";
                } else {
                ...
                if (menuTp == '1') {//功能按钮即最后一级
                    ...
                    if (creatorAndAdmin || isSpecificMenu) {
                        ...
                        dataTpHtml += " onclick=\"toroleusrs2(" + nodeid + "," + roleId + ",'" + mids + "');\""
                    }
                    dataTpHtml += "/>自定义";
                }
                var dataTpHtml2 = "";
