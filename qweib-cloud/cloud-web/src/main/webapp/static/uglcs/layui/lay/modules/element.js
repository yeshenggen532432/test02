  ...
  ,call = {
    ...
    ,tabDelete: function(e, othis){
      ...
      ,filter = parents.attr('lay-filter');
          ...
          var currentTab = $('#LAY_app_body .layui-show iframe')[0].contentWindow;
          var dfd = $.Deferred();
          ...
          $.when(checkLeave(dfd)).done(function () {
            ...
            layui.event.call(that, MOD_NAME, 'tabBeforeDelete('+ filter +')',{
              elem: parents,
              index: index
            });
            li.remove();
            ...
            layui.event.call(that, MOD_NAME, 'tabDelete('+ filter +')', {
              elem: parents
              ,index: index
            });
          }).fail(function () {
    ...
    var that = this, elemFilter = function(){
      ...
      ,nav: function(){
        var TIME = 200, timer = {}, timerMore = {}, timeEnd = {}, follow = function(bar, nav, index){
          ...
          nav.find('a.focus').removeClass('focus');
          othis.find('a:first').addClass('focus');
